...
PHP_METHOD(php_wxBookCtrlBase, AddPage)
{
    ...
    if(!already_called && arguments_received >= 2  && arguments_received <= 4 && (current_object_type == PHP_WXAUINOTEBOOK_TYPE))
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'zs|bO' (&page1, &caption1, &caption_len1, &select1, &bitmap1, php_wxBitmapBundle_entry)\n");
        #endif

        char parse_parameters_string[] = "zs|bO";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &page1, &caption1, &caption_len1, &select1, &bitmap1, php_wxBitmapBundle_entry ) == SUCCESS)
        {
            if(arguments_received >= 1){
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            case 2:
            {
                ...
                native_object = new wxListbook_php((wxWindow*) object_pointer1_0, (wxWindowID) id1);

                native_object->references.Initialize();
                ((wxListbook_php*) native_object)->references.AddReference(parent1, "wxListbook::wxListbook at call 2 with 2 argument(s)");
                break;
            }
            case 3:
            {
                ...
                native_object = new wxListbook_php((wxWindow*) object_pointer1_0, (wxWindowID) id1, *(wxPoint*) object_pointer1_2);

                native_object->references.Initialize();
                ((wxListbook_php*) native_object)->references.AddReference(parent1, "wxListbook::wxListbook at call 2 with 3 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(pos1, "wxListbook::wxListbook at call 4 with 3 argument(s)");
                break;
            }
            case 4:
            {
                ...
                native_object = new wxListbook_php((wxWindow*) object_pointer1_0, (wxWindowID) id1, *(wxPoint*) object_pointer1_2, *(wxSize*) object_pointer1_3);

                native_object->references.Initialize();
                ((wxListbook_php*) native_object)->references.AddReference(parent1, "wxListbook::wxListbook at call 2 with 4 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(pos1, "wxListbook::wxListbook at call 4 with 4 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(size1, "wxListbook::wxListbook at call 4 with 4 argument(s)");
                break;
            }
            case 5:
            {
                ...
                native_object = new wxListbook_php((wxWindow*) object_pointer1_0, (wxWindowID) id1, *(wxPoint*) object_pointer1_2, *(wxSize*) object_pointer1_3, (long) style1);

                native_object->references.Initialize();
                ((wxListbook_php*) native_object)->references.AddReference(parent1, "wxListbook::wxListbook at call 2 with 5 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(pos1, "wxListbook::wxListbook at call 4 with 5 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(size1, "wxListbook::wxListbook at call 4 with 5 argument(s)");
                break;
            }
            case 6:
            {
                ...
                native_object = new wxListbook_php((wxWindow*) object_pointer1_0, (wxWindowID) id1, *(wxPoint*) object_pointer1_2, *(wxSize*) object_pointer1_3, (long) style1, wxString(name1, wxConvUTF8));

                native_object->references.Initialize();
                ((wxListbook_php*) native_object)->references.AddReference(parent1, "wxListbook::wxListbook at call 2 with 6 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(pos1, "wxListbook::wxListbook at call 4 with 6 argument(s)");
                ((wxListbook_php*) native_object)->references.AddReference(size1, "wxListbook::wxListbook at call 4 with 6 argument(s)");
                break;
            }
        }
    }
