...
static zend_function_entry php_wxGBPosition_functions[] = {
    PHP_ME(php_wxGBPosition, GetCol, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBPosition, GetRow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBPosition, SetCol, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBPosition, SetRow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBPosition, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxGridBagSizer_functions[] = {
    PHP_ME(php_wxGridBagSizer, Add, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, CalcMin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, CheckForIntersection, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, FindItem, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, FindItemAtPoint, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, FindItemAtPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, FindItemWithData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridBagSizer, GetCellSize, arginfo_null, ZEND_ACC_PUBLIC)
    ...
    PHP_ME(php_wxGridBagSizer, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxGBSizerItem_functions[] = {
    PHP_ME(php_wxGBSizerItem, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxGBSizerItem, SetSpan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, SetPos, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, SetGBSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, Intersects, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, GetSpan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, GetPos, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, GetGBSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSizerItem, GetEndPos, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxGBSpan_functions[] = {
    PHP_ME(php_wxGBSpan, GetColspan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSpan, GetRowspan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSpan, SetColspan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSpan, SetRowspan, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGBSpan, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxLayoutAlgorithm_functions[] = {
    PHP_ME(php_wxLayoutAlgorithm, LayoutFrame, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxLayoutAlgorithm, LayoutMDIFrame, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxLayoutAlgorithm, LayoutWindow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxLayoutAlgorithm, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxSizer_functions[] = {
    PHP_ME(php_wxSizer, Show, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxSizer, SetSizeHints, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, SetMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, SetItemMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, SetDimension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Replace, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Remove, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, PrependStretchSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, PrependSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Prepend, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Layout, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, IsShown, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, IsEmpty, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, InsertStretchSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, InsertSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Insert, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, InformFirstDirection, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Hide, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetItemCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, FitInside, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Fit, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Detach, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, ComputeFittingWindowSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, ComputeFittingClientSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Add, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, AddSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, AddStretchSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, Clear, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetContainingWindow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetItem, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizer, GetItemById, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxStdDialogButtonSizer_functions[] = {
    ...
    PHP_ME(php_wxStdDialogButtonSizer, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxSizerItem_functions[] = {
    PHP_ME(php_wxSizerItem, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxSizerItem, Show, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetUserData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetRatio, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetProportion, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetInitSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetFlag, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetDimension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, SetBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, IsWindow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, IsSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, IsSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, IsShown, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, AssignSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, AssignSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, AssignWindow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, CalcMin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, DeleteWindows, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, DetachSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetFlag, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetProportion, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetRatio, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetRect, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetSizer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetSpacer, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetUserData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerItem, GetWindow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxSizerFlags_functions[] = {
    PHP_ME(php_wxSizerFlags, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxSizerFlags, TripleBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Top, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Shaped, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Right, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, ReserveSpaceEvenIfHidden, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Proportion, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Left, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, GetDefaultBorder, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, FixedMinSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Expand, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, DoubleHorzBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, DoubleBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Centre, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Center, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Bottom, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Border, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSizerFlags, Align, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxFlexGridSizer_functions[] = {
    PHP_ME(php_wxFlexGridSizer, AddGrowableCol, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFlexGridSizer, AddGrowableRow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFlexGridSizer, CalcMin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFlexGridSizer, GetFlexibleDirection, arginfo_null, ZEND_ACC_PUBLIC)
    ...
    PHP_ME(php_wxFlexGridSizer, SetNonFlexibleGrowMode, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFlexGridSizer, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxGridSizer_functions[] = {
    PHP_ME(php_wxGridSizer, CalcMin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridSizer, GetCols, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridSizer, GetEffectiveColsCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridSizer, GetEffectiveRowsCount, arginfo_null, ZEND_ACC_PUBLIC)
    ...
    PHP_ME(php_wxGridSizer, SetVGap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGridSizer, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
