...
static zend_function_entry php_wxWidgets_functions[] = {
     ...
     */
    PHP_FALIAS(wxHandleFatalExceptions, php_wxHandleFatalExceptions, arginfo_null)
    PHP_FALIAS(wxInitialize, php_wxInitialize, arginfo_null)
    PHP_FALIAS(wxUninitialize, php_wxUninitialize, arginfo_null)
    PHP_FALIAS(wxWakeUpIdle, php_wxWakeUpIdle, arginfo_null)
    PHP_FALIAS(wxYield, php_wxYield, arginfo_null)
    PHP_FALIAS(wxSafeYield, php_wxSafeYield, arginfo_null)
    PHP_FALIAS(wxExit, php_wxExit, arginfo_null)
    PHP_FALIAS(wxIsDragResultOk, php_wxIsDragResultOk, arginfo_null)
    PHP_FALIAS(wxFromString, php_wxFromString, arginfo_null)
    PHP_FALIAS(wxToString, php_wxToString, arginfo_null)
    PHP_FALIAS(wxSafeShowMessage, php_wxSafeShowMessage, arginfo_null)
    PHP_FALIAS(wxSysErrorCode, php_wxSysErrorCode, arginfo_null)
    PHP_FALIAS(wxSysErrorMsgStr, php_wxSysErrorMsgStr, arginfo_null)
    PHP_FALIAS(wxIsMainThread, php_wxIsMainThread, arginfo_null)
    PHP_FALIAS(wxMutexGuiEnter, php_wxMutexGuiEnter, arginfo_null)
    PHP_FALIAS(wxMutexGuiLeave, php_wxMutexGuiLeave, arginfo_null)
    PHP_FALIAS(wxAboutBox, php_wxAboutBox, arginfo_null)
    PHP_FALIAS(wxStringSortAscending, php_wxStringSortAscending, arginfo_null)
    PHP_FALIAS(wxStringSortDescending, php_wxStringSortDescending, arginfo_null)
    PHP_FALIAS(wxDictionaryStringSortAscending, php_wxDictionaryStringSortAscending, arginfo_null)
    PHP_FALIAS(wxDictionaryStringSortDescending, php_wxDictionaryStringSortDescending, arginfo_null)
    PHP_FALIAS(wxNaturalStringSortAscending, php_wxNaturalStringSortAscending, arginfo_null)
    PHP_FALIAS(wxNaturalStringSortDescending, php_wxNaturalStringSortDescending, arginfo_null)
    PHP_FALIAS(wxCmpNatural, php_wxCmpNatural, arginfo_null)
    PHP_FALIAS(wxCmpNaturalGeneric, php_wxCmpNaturalGeneric, arginfo_null)
    PHP_FALIAS(wxBase64Encode, php_wxBase64Encode, arginfo_null)
    PHP_FALIAS(wxBase64DecodedSize, php_wxBase64DecodedSize, arginfo_null)
    PHP_FALIAS(wxBase64EncodedSize, php_wxBase64EncodedSize, arginfo_null)
    PHP_FALIAS(wxBase64Decode, php_wxBase64Decode, arginfo_null)
    PHP_FALIAS(wxGetSingleChoiceIndex, php_wxGetSingleChoiceIndex, arginfo_null)
    PHP_FALIAS(wxGetSingleChoice, php_wxGetSingleChoice, arginfo_null)
    PHP_FALIAS(wxGetColourFromUser, php_wxGetColourFromUser, arginfo_null)
    PHP_FALIAS(wxAutoBufferedPaintDCFactory, php_wxAutoBufferedPaintDCFactory, arginfo_null)
    PHP_FALIAS(wxAbort, php_wxAbort, arginfo_null)
    PHP_FALIAS(wxDisableAsserts, php_wxDisableAsserts, arginfo_null)
    PHP_FALIAS(wxIsDebuggerRunning, php_wxIsDebuggerRunning, arginfo_null)
    PHP_FALIAS(wxSetDefaultAssertHandler, php_wxSetDefaultAssertHandler, arginfo_null)
    PHP_FALIAS(wxTrap, php_wxTrap, arginfo_null)
    PHP_FALIAS(wxDirSelector, php_wxDirSelector, arginfo_null)
    PHP_FALIAS(wxNewEventType, php_wxNewEventType, arginfo_null)
    PHP_FALIAS(wxPostEvent, php_wxPostEvent, arginfo_null)
    PHP_FALIAS(wxQueueEvent, php_wxQueueEvent, arginfo_null)
    PHP_FALIAS(wxFileSelector, php_wxFileSelector, arginfo_null)
    PHP_FALIAS(wxFileSelectorEx, php_wxFileSelectorEx, arginfo_null)
    PHP_FALIAS(wxLoadFileSelector, php_wxLoadFileSelector, arginfo_null)
    PHP_FALIAS(wxSaveFileSelector, php_wxSaveFileSelector, arginfo_null)
    PHP_FALIAS(wxGetOSDirectory, php_wxGetOSDirectory, arginfo_null)
    PHP_FALIAS(wxParseCommonDialogsFilter, php_wxParseCommonDialogsFilter, arginfo_null)
    PHP_FALIAS(wxDirExists, php_wxDirExists, arginfo_null)
    PHP_FALIAS(wxRenameFile, php_wxRenameFile, arginfo_null)
    PHP_FALIAS(wxCopyFile, php_wxCopyFile, arginfo_null)
    PHP_FALIAS(wxFileExists, php_wxFileExists, arginfo_null)
    PHP_FALIAS(wxMatchWild, php_wxMatchWild, arginfo_null)
    PHP_FALIAS(wxPathOnly, php_wxPathOnly, arginfo_null)
    PHP_FALIAS(wxIsWild, php_wxIsWild, arginfo_null)
    PHP_FALIAS(wxIsAbsolutePath, php_wxIsAbsolutePath, arginfo_null)
    PHP_FALIAS(wxGetCwd, php_wxGetCwd, arginfo_null)
    PHP_FALIAS(wxSetWorkingDirectory, php_wxSetWorkingDirectory, arginfo_null)
    PHP_FALIAS(wxConcatFiles, php_wxConcatFiles, arginfo_null)
    PHP_FALIAS(wxRemoveFile, php_wxRemoveFile, arginfo_null)
    PHP_FALIAS(wxMkdir, php_wxMkdir, arginfo_null)
    PHP_FALIAS(wxRmdir, php_wxRmdir, arginfo_null)
    PHP_FALIAS(wxFindNextFile, php_wxFindNextFile, arginfo_null)
    PHP_FALIAS(wxFindFirstFile, php_wxFindFirstFile, arginfo_null)
    PHP_FALIAS(wxGetFileKind, php_wxGetFileKind, arginfo_null)
    PHP_FALIAS(wxGetFontFromUser, php_wxGetFontFromUser, arginfo_null)
    PHP_FALIAS(wxColourDisplay, php_wxColourDisplay, arginfo_null)
    PHP_FALIAS(wxDisplayDepth, php_wxDisplayDepth, arginfo_null)
    PHP_FALIAS(wxSetCursor, php_wxSetCursor, arginfo_null)
    PHP_FALIAS(wxClientDisplayRect, php_wxClientDisplayRect, arginfo_null)
    PHP_FALIAS(wxGetClientDisplayRect, php_wxGetClientDisplayRect, arginfo_null)
    PHP_FALIAS(wxGetDisplayPPI, php_wxGetDisplayPPI, arginfo_null)
    PHP_FALIAS(wxDisplaySize, php_wxDisplaySize, arginfo_null)
    PHP_FALIAS(wxGetDisplaySize, php_wxGetDisplaySize, arginfo_null)
    PHP_FALIAS(wxDisplaySizeMM, php_wxDisplaySizeMM, arginfo_null)
    ...
    PHP_FALIAS(wxDegToRad, php_wxDegToRad, arginfo_null)
    PHP_FALIAS(wxRadToDeg, php_wxRadToDeg, arginfo_null)
    PHP_FALIAS(wxCTZ, php_wxCTZ, arginfo_null)
    PHP_FALIAS(wxRound, php_wxRound, arginfo_null)
    ...
    PHP_FALIAS(wxRichTextBitlistsEqPartial, php_wxRichTextBitlistsEqPartial, arginfo_null)
    PHP_FALIAS(wxRichTextDecimalToRoman, php_wxRichTextDecimalToRoman, arginfo_null)
    PHP_FALIAS(wxTextAttrCollectCommonAttributes, php_wxTextAttrCollectCommonAttributes, arginfo_null)
    PHP_FALIAS(wxRichTextModuleInit, php_wxRichTextModuleInit, arginfo_null)
    PHP_FALIAS(wxGetStockLabel, php_wxGetStockLabel, arginfo_null)
    PHP_FALIAS(wxGetTextFromUser, php_wxGetTextFromUser, arginfo_null)
    PHP_FALIAS(wxGetPasswordFromUser, php_wxGetPasswordFromUser, arginfo_null)
    PHP_FALIAS(wxGetTimeZone, php_wxGetTimeZone, arginfo_null)
    PHP_FALIAS(wxGetLocalTime, php_wxGetLocalTime, arginfo_null)
    ...
    PHP_FALIAS(wxBell, php_wxBell, arginfo_null)
    PHP_FALIAS(wxInfoMessageBox, php_wxInfoMessageBox, arginfo_null)
    PHP_FALIAS(wxGetLibraryVersionInfo, php_wxGetLibraryVersionInfo, arginfo_null)
    ...
    PHP_FALIAS(wxGetMousePosition, php_wxGetMousePosition, arginfo_null)
    PHP_FALIAS(wxGetMouseState, php_wxGetMouseState, arginfo_null)
    PHP_FALIAS(wxEnableTopLevelWindows, php_wxEnableTopLevelWindows, arginfo_null)
    PHP_FALIAS(wxFindWindowAtPoint, php_wxFindWindowAtPoint, arginfo_null)
    PHP_FALIAS(wxFindMenuItemId, php_wxFindMenuItemId, arginfo_null)
    PHP_FALIAS(wxRegisterId, php_wxRegisterId, arginfo_null)
    PHP_FALIAS(wxLaunchDefaultApplication, php_wxLaunchDefaultApplication, arginfo_null)
    PHP_FALIAS(wxLaunchDefaultBrowser, php_wxLaunchDefaultBrowser, arginfo_null)
    PHP_FALIAS(wxStripMenuCodes, php_wxStripMenuCodes, arginfo_null)
    PHP_FALIAS(wxGetHomeDir, php_wxGetHomeDir, arginfo_null)
    PHP_FALIAS(wxGetFullHostName, php_wxGetFullHostName, arginfo_null)
    PHP_FALIAS(wxGetUserHome, php_wxGetUserHome, arginfo_null)
    PHP_FALIAS(wxGetOsDescription, php_wxGetOsDescription, arginfo_null)
    PHP_FALIAS(wxGetOsVersion, php_wxGetOsVersion, arginfo_null)
    PHP_FALIAS(wxCheckOsVersion, php_wxCheckOsVersion, arginfo_null)
    ...
    PHP_FALIAS(wxShutdown, php_wxShutdown, arginfo_null)
    PHP_FALIAS(wxMicroSleep, php_wxMicroSleep, arginfo_null)
    PHP_FALIAS(wxMilliSleep, php_wxMilliSleep, arginfo_null)
    PHP_FALIAS(wxNow, php_wxNow, arginfo_null)
    PHP_FALIAS(wxSleep, php_wxSleep, arginfo_null)
    PHP_FALIAS(wxDecToHex, php_wxDecToHex, arginfo_null)
    PHP_FALIAS(wxHexToDec, php_wxHexToDec, arginfo_null)
    PHP_FALIAS(wxIsEmpty, php_wxIsEmpty, arginfo_null)
    PHP_FALIAS(wxTmemchr, php_wxTmemchr, arginfo_null)
    PHP_FALIAS(wxTmemcmp, php_wxTmemcmp, arginfo_null)
    PHP_FALIAS(wxTmemcpy, php_wxTmemcpy, arginfo_null)
    PHP_FALIAS(wxTmemmove, php_wxTmemmove, arginfo_null)
    PHP_FALIAS(wxTmemset, php_wxTmemset, arginfo_null)
    PHP_FALIAS(wxSetlocale, php_wxSetlocale, arginfo_null)
    PHP_FALIAS(wxStrlen, php_wxStrlen, arginfo_null)
    PHP_FALIAS(wxStrnlen, php_wxStrnlen, arginfo_null)
    PHP_FALIAS(wxStrdup, php_wxStrdup, arginfo_null)
    PHP_FALIAS(wxStrcpy, php_wxStrcpy, arginfo_null)
    PHP_FALIAS(wxStrncpy, php_wxStrncpy, arginfo_null)
    PHP_FALIAS(wxStrlcpy, php_wxStrlcpy, arginfo_null)
    PHP_FALIAS(wxStrcat, php_wxStrcat, arginfo_null)
    PHP_FALIAS(wxStrncat, php_wxStrncat, arginfo_null)
    PHP_FALIAS(wxStrxfrm, php_wxStrxfrm, arginfo_null)
    PHP_FALIAS(wxStrstr, php_wxStrstr, arginfo_null)
    PHP_FALIAS(wxStrchr, php_wxStrchr, arginfo_null)
    PHP_FALIAS(wxStrrchr, php_wxStrrchr, arginfo_null)
    PHP_FALIAS(wxStrpbrk, php_wxStrpbrk, arginfo_null)
    PHP_FALIAS(wxRemove, php_wxRemove, arginfo_null)
    PHP_FALIAS(wxRename, php_wxRename, arginfo_null)
    PHP_FALIAS(wxAtoi, php_wxAtoi, arginfo_null)
    PHP_FALIAS(wxAtol, php_wxAtol, arginfo_null)
    PHP_FALIAS(wxAtof, php_wxAtof, arginfo_null)
    PHP_FALIAS(wxSystem, php_wxSystem, arginfo_null)
    PHP_FALIAS(wxDynamicCast, php_wxDynamicCast, arginfo_null)
...
PHP_MINIT_FUNCTION(php_wxWidgets)
{
    ...
    REGISTER_STRINGL_CONSTANT("wxART_TOOLBAR", reinterpret_cast<const char*>(wxART_TOOLBAR.ToUTF8().data()), wxART_TOOLBAR.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_MENU", reinterpret_cast<const char*>(wxART_MENU.ToUTF8().data()), wxART_MENU.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FRAME_ICON", reinterpret_cast<const char*>(wxART_FRAME_ICON.ToUTF8().data()), wxART_FRAME_ICON.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_CMN_DIALOG", reinterpret_cast<const char*>(wxART_CMN_DIALOG.ToUTF8().data()), wxART_CMN_DIALOG.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_BROWSER", reinterpret_cast<const char*>(wxART_HELP_BROWSER.ToUTF8().data()), wxART_HELP_BROWSER.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_MESSAGE_BOX", reinterpret_cast<const char*>(wxART_MESSAGE_BOX.ToUTF8().data()), wxART_MESSAGE_BOX.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_BUTTON", reinterpret_cast<const char*>(wxART_BUTTON.ToUTF8().data()), wxART_BUTTON.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_LIST", reinterpret_cast<const char*>(wxART_LIST.ToUTF8().data()), wxART_LIST.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_OTHER", reinterpret_cast<const char*>(wxART_OTHER.ToUTF8().data()), wxART_OTHER.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_ADD_BOOKMARK", reinterpret_cast<const char*>(wxART_ADD_BOOKMARK.ToUTF8().data()), wxART_ADD_BOOKMARK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_DEL_BOOKMARK", reinterpret_cast<const char*>(wxART_DEL_BOOKMARK.ToUTF8().data()), wxART_DEL_BOOKMARK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_SIDE_PANEL", reinterpret_cast<const char*>(wxART_HELP_SIDE_PANEL.ToUTF8().data()), wxART_HELP_SIDE_PANEL.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_SETTINGS", reinterpret_cast<const char*>(wxART_HELP_SETTINGS.ToUTF8().data()), wxART_HELP_SETTINGS.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_BOOK", reinterpret_cast<const char*>(wxART_HELP_BOOK.ToUTF8().data()), wxART_HELP_BOOK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_FOLDER", reinterpret_cast<const char*>(wxART_HELP_FOLDER.ToUTF8().data()), wxART_HELP_FOLDER.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP_PAGE", reinterpret_cast<const char*>(wxART_HELP_PAGE.ToUTF8().data()), wxART_HELP_PAGE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_BACK", reinterpret_cast<const char*>(wxART_GO_BACK.ToUTF8().data()), wxART_GO_BACK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_FORWARD", reinterpret_cast<const char*>(wxART_GO_FORWARD.ToUTF8().data()), wxART_GO_FORWARD.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_UP", reinterpret_cast<const char*>(wxART_GO_UP.ToUTF8().data()), wxART_GO_UP.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_DOWN", reinterpret_cast<const char*>(wxART_GO_DOWN.ToUTF8().data()), wxART_GO_DOWN.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_TO_PARENT", reinterpret_cast<const char*>(wxART_GO_TO_PARENT.ToUTF8().data()), wxART_GO_TO_PARENT.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_HOME", reinterpret_cast<const char*>(wxART_GO_HOME.ToUTF8().data()), wxART_GO_HOME.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GOTO_FIRST", reinterpret_cast<const char*>(wxART_GOTO_FIRST.ToUTF8().data()), wxART_GOTO_FIRST.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GOTO_LAST", reinterpret_cast<const char*>(wxART_GOTO_LAST.ToUTF8().data()), wxART_GOTO_LAST.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FILE_OPEN", reinterpret_cast<const char*>(wxART_FILE_OPEN.ToUTF8().data()), wxART_FILE_OPEN.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FILE_SAVE", reinterpret_cast<const char*>(wxART_FILE_SAVE.ToUTF8().data()), wxART_FILE_SAVE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FILE_SAVE_AS", reinterpret_cast<const char*>(wxART_FILE_SAVE_AS.ToUTF8().data()), wxART_FILE_SAVE_AS.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_PRINT", reinterpret_cast<const char*>(wxART_PRINT.ToUTF8().data()), wxART_PRINT.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HELP", reinterpret_cast<const char*>(wxART_HELP.ToUTF8().data()), wxART_HELP.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_TIP", reinterpret_cast<const char*>(wxART_TIP.ToUTF8().data()), wxART_TIP.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_REPORT_VIEW", reinterpret_cast<const char*>(wxART_REPORT_VIEW.ToUTF8().data()), wxART_REPORT_VIEW.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_LIST_VIEW", reinterpret_cast<const char*>(wxART_LIST_VIEW.ToUTF8().data()), wxART_LIST_VIEW.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_NEW_DIR", reinterpret_cast<const char*>(wxART_NEW_DIR.ToUTF8().data()), wxART_NEW_DIR.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_HARDDISK", reinterpret_cast<const char*>(wxART_HARDDISK.ToUTF8().data()), wxART_HARDDISK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FLOPPY", reinterpret_cast<const char*>(wxART_FLOPPY.ToUTF8().data()), wxART_FLOPPY.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_CDROM", reinterpret_cast<const char*>(wxART_CDROM.ToUTF8().data()), wxART_CDROM.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_REMOVABLE", reinterpret_cast<const char*>(wxART_REMOVABLE.ToUTF8().data()), wxART_REMOVABLE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FOLDER", reinterpret_cast<const char*>(wxART_FOLDER.ToUTF8().data()), wxART_FOLDER.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FOLDER_OPEN", reinterpret_cast<const char*>(wxART_FOLDER_OPEN.ToUTF8().data()), wxART_FOLDER_OPEN.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_GO_DIR_UP", reinterpret_cast<const char*>(wxART_GO_DIR_UP.ToUTF8().data()), wxART_GO_DIR_UP.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_EXECUTABLE_FILE", reinterpret_cast<const char*>(wxART_EXECUTABLE_FILE.ToUTF8().data()), wxART_EXECUTABLE_FILE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_NORMAL_FILE", reinterpret_cast<const char*>(wxART_NORMAL_FILE.ToUTF8().data()), wxART_NORMAL_FILE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_TICK_MARK", reinterpret_cast<const char*>(wxART_TICK_MARK.ToUTF8().data()), wxART_TICK_MARK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_CROSS_MARK", reinterpret_cast<const char*>(wxART_CROSS_MARK.ToUTF8().data()), wxART_CROSS_MARK.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_ERROR", reinterpret_cast<const char*>(wxART_ERROR.ToUTF8().data()), wxART_ERROR.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_QUESTION", reinterpret_cast<const char*>(wxART_QUESTION.ToUTF8().data()), wxART_QUESTION.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_WARNING", reinterpret_cast<const char*>(wxART_WARNING.ToUTF8().data()), wxART_WARNING.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_INFORMATION", reinterpret_cast<const char*>(wxART_INFORMATION.ToUTF8().data()), wxART_INFORMATION.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_MISSING_IMAGE", reinterpret_cast<const char*>(wxART_MISSING_IMAGE.ToUTF8().data()), wxART_MISSING_IMAGE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_COPY", reinterpret_cast<const char*>(wxART_COPY.ToUTF8().data()), wxART_COPY.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_CUT", reinterpret_cast<const char*>(wxART_CUT.ToUTF8().data()), wxART_CUT.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_PASTE", reinterpret_cast<const char*>(wxART_PASTE.ToUTF8().data()), wxART_PASTE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_DELETE", reinterpret_cast<const char*>(wxART_DELETE.ToUTF8().data()), wxART_DELETE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_NEW", reinterpret_cast<const char*>(wxART_NEW.ToUTF8().data()), wxART_NEW.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_UNDO", reinterpret_cast<const char*>(wxART_UNDO.ToUTF8().data()), wxART_UNDO.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_REDO", reinterpret_cast<const char*>(wxART_REDO.ToUTF8().data()), wxART_REDO.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_PLUS", reinterpret_cast<const char*>(wxART_PLUS.ToUTF8().data()), wxART_PLUS.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_MINUS", reinterpret_cast<const char*>(wxART_MINUS.ToUTF8().data()), wxART_MINUS.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_CLOSE", reinterpret_cast<const char*>(wxART_CLOSE.ToUTF8().data()), wxART_CLOSE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_QUIT", reinterpret_cast<const char*>(wxART_QUIT.ToUTF8().data()), wxART_QUIT.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FIND", reinterpret_cast<const char*>(wxART_FIND.ToUTF8().data()), wxART_FIND.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FIND_AND_REPLACE", reinterpret_cast<const char*>(wxART_FIND_AND_REPLACE.ToUTF8().data()), wxART_FIND_AND_REPLACE.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_FULL_SCREEN", reinterpret_cast<const char*>(wxART_FULL_SCREEN.ToUTF8().data()), wxART_FULL_SCREEN.Len(), CONST_CS | CONST_PERSISTENT);
    REGISTER_STRINGL_CONSTANT("wxART_EDIT", reinterpret_cast<const char*>(wxART_EDIT.ToUTF8().data()), wxART_EDIT.Len(), CONST_CS | CONST_PERSISTENT);
