...
struct _wxphp_global_consts_t wxphpGlobalConsts;
...
static zend_function_entry php_wxWidgets_functions[] = {
     ...
     */
    PHP_FALIAS(wxHandleFatalExceptions, php_wxHandleFatalExceptions, arginfo_tmp_placeholder)
    PHP_FALIAS(wxInitialize, php_wxInitialize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxUninitialize, php_wxUninitialize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxWakeUpIdle, php_wxWakeUpIdle, arginfo_tmp_placeholder)
    PHP_FALIAS(wxYield, php_wxYield, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSafeYield, php_wxSafeYield, arginfo_tmp_placeholder)
    PHP_FALIAS(wxExit, php_wxExit, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsDragResultOk, php_wxIsDragResultOk, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFromString, php_wxFromString, arginfo_tmp_placeholder)
    PHP_FALIAS(wxToString, php_wxToString, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSafeShowMessage, php_wxSafeShowMessage, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSysErrorCode, php_wxSysErrorCode, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSysErrorMsgStr, php_wxSysErrorMsgStr, arginfo_tmp_placeholder)
    PHP_FALIAS(wxASCII_STR, php_wxASCII_STR, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsMainThread, php_wxIsMainThread, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMutexGuiEnter, php_wxMutexGuiEnter, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMutexGuiLeave, php_wxMutexGuiLeave, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAboutBox, php_wxAboutBox, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStringSortAscending, php_wxStringSortAscending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStringSortDescending, php_wxStringSortDescending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDictionaryStringSortAscending, php_wxDictionaryStringSortAscending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDictionaryStringSortDescending, php_wxDictionaryStringSortDescending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxNaturalStringSortAscending, php_wxNaturalStringSortAscending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxNaturalStringSortDescending, php_wxNaturalStringSortDescending, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCmpNatural, php_wxCmpNatural, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCmpNaturalGeneric, php_wxCmpNaturalGeneric, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBase64Encode, php_wxBase64Encode, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBase64DecodedSize, php_wxBase64DecodedSize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBase64EncodedSize, php_wxBase64EncodedSize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBase64Decode, php_wxBase64Decode, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetSingleChoiceIndex, php_wxGetSingleChoiceIndex, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetSingleChoice, php_wxGetSingleChoice, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetColourFromUser, php_wxGetColourFromUser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAutoBufferedPaintDCFactory, php_wxAutoBufferedPaintDCFactory, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAbort, php_wxAbort, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDisableAsserts, php_wxDisableAsserts, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsDebuggerRunning, php_wxIsDebuggerRunning, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSetDefaultAssertHandler, php_wxSetDefaultAssertHandler, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTrap, php_wxTrap, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDirSelector, php_wxDirSelector, arginfo_tmp_placeholder)
    PHP_FALIAS(wxNewEventType, php_wxNewEventType, arginfo_tmp_placeholder)
    PHP_FALIAS(wxPostEvent, php_wxPostEvent, arginfo_tmp_placeholder)
    PHP_FALIAS(wxQueueEvent, php_wxQueueEvent, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFileSelector, php_wxFileSelector, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFileSelectorEx, php_wxFileSelectorEx, arginfo_tmp_placeholder)
    PHP_FALIAS(wxLoadFileSelector, php_wxLoadFileSelector, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSaveFileSelector, php_wxSaveFileSelector, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetOSDirectory, php_wxGetOSDirectory, arginfo_tmp_placeholder)
    PHP_FALIAS(wxParseCommonDialogsFilter, php_wxParseCommonDialogsFilter, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDirExists, php_wxDirExists, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRenameFile, php_wxRenameFile, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCopyFile, php_wxCopyFile, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFileExists, php_wxFileExists, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMatchWild, php_wxMatchWild, arginfo_tmp_placeholder)
    PHP_FALIAS(wxPathOnly, php_wxPathOnly, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsWild, php_wxIsWild, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsAbsolutePath, php_wxIsAbsolutePath, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetCwd, php_wxGetCwd, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSetWorkingDirectory, php_wxSetWorkingDirectory, arginfo_tmp_placeholder)
    PHP_FALIAS(wxConcatFiles, php_wxConcatFiles, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRemoveFile, php_wxRemoveFile, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMkdir, php_wxMkdir, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRmdir, php_wxRmdir, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFindNextFile, php_wxFindNextFile, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFindFirstFile, php_wxFindFirstFile, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetFileKind, php_wxGetFileKind, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetFontFromUser, php_wxGetFontFromUser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxColourDisplay, php_wxColourDisplay, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDisplayDepth, php_wxDisplayDepth, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSetCursor, php_wxSetCursor, arginfo_tmp_placeholder)
    PHP_FALIAS(wxClientDisplayRect, php_wxClientDisplayRect, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetClientDisplayRect, php_wxGetClientDisplayRect, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetDisplayPPI, php_wxGetDisplayPPI, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDisplaySize, php_wxDisplaySize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetDisplaySize, php_wxGetDisplaySize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDisplaySizeMM, php_wxDisplaySizeMM, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetDisplaySizeMM, php_wxGetDisplaySizeMM, arginfo_tmp_placeholder)
    PHP_FALIAS(wxInitAllImageHandlers, php_wxInitAllImageHandlers, arginfo_tmp_placeholder)
    PHP_FALIAS(wxEntryCleanup, php_wxEntryCleanup, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFinite, php_wxFinite, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGCD, php_wxGCD, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsNaN, php_wxIsNaN, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDegToRad, php_wxDegToRad, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRadToDeg, php_wxRadToDeg, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCTZ, php_wxCTZ, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsSameDouble, php_wxIsSameDouble, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsNullDouble, php_wxIsNullDouble, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMulDivInt32, php_wxMulDivInt32, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMessageBox, php_wxMessageBox, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetNumberFromUser, php_wxGetNumberFromUser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCreateDynamicObject, php_wxCreateDynamicObject, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFindWindowAtPointer, php_wxFindWindowAtPointer, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetActiveWindow, php_wxGetActiveWindow, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetTopLevelParent, php_wxGetTopLevelParent, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDumpWindow, php_wxDumpWindow, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsRunningUnderWine, php_wxIsRunningUnderWine, arginfo_tmp_placeholder)
    PHP_FALIAS(wxPGGetDefaultImageWildcard, php_wxPGGetDefaultImageWildcard, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRichTextHasStyle, php_wxRichTextHasStyle, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRichTextCombineBitlists, php_wxRichTextCombineBitlists, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRichTextBitlistsEqPartial, php_wxRichTextBitlistsEqPartial, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRichTextDecimalToRoman, php_wxRichTextDecimalToRoman, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTextAttrCollectCommonAttributes, php_wxTextAttrCollectCommonAttributes, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRichTextModuleInit, php_wxRichTextModuleInit, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetStockLabel, php_wxGetStockLabel, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetTextFromUser, php_wxGetTextFromUser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetPasswordFromUser, php_wxGetPasswordFromUser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetTimeZone, php_wxGetTimeZone, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetLocalTime, php_wxGetLocalTime, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetUTCTime, php_wxGetUTCTime, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStringTokenize, php_wxStringTokenize, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetTranslation, php_wxGetTranslation, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetUIDateFormat, php_wxGetUIDateFormat, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBeginBusyCursor, php_wxBeginBusyCursor, arginfo_tmp_placeholder)
    PHP_FALIAS(wxEndBusyCursor, php_wxEndBusyCursor, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsBusy, php_wxIsBusy, arginfo_tmp_placeholder)
    PHP_FALIAS(wxBell, php_wxBell, arginfo_tmp_placeholder)
    PHP_FALIAS(wxInfoMessageBox, php_wxInfoMessageBox, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetLibraryVersionInfo, php_wxGetLibraryVersionInfo, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetenv, php_wxGetenv, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSetEnv, php_wxSetEnv, arginfo_tmp_placeholder)
    PHP_FALIAS(wxUnsetEnv, php_wxUnsetEnv, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSecureZeroMemory, php_wxSecureZeroMemory, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetBatteryState, php_wxGetBatteryState, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetPowerType, php_wxGetPowerType, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetKeyState, php_wxGetKeyState, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetMousePosition, php_wxGetMousePosition, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetMouseState, php_wxGetMouseState, arginfo_tmp_placeholder)
    PHP_FALIAS(wxEnableTopLevelWindows, php_wxEnableTopLevelWindows, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFindWindowAtPoint, php_wxFindWindowAtPoint, arginfo_tmp_placeholder)
    PHP_FALIAS(wxFindMenuItemId, php_wxFindMenuItemId, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRegisterId, php_wxRegisterId, arginfo_tmp_placeholder)
    PHP_FALIAS(wxLaunchDefaultApplication, php_wxLaunchDefaultApplication, arginfo_tmp_placeholder)
    PHP_FALIAS(wxLaunchDefaultBrowser, php_wxLaunchDefaultBrowser, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStripMenuCodes, php_wxStripMenuCodes, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetHomeDir, php_wxGetHomeDir, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetFullHostName, php_wxGetFullHostName, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetUserHome, php_wxGetUserHome, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetOsDescription, php_wxGetOsDescription, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetOsVersion, php_wxGetOsVersion, arginfo_tmp_placeholder)
    PHP_FALIAS(wxCheckOsVersion, php_wxCheckOsVersion, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsPlatform64Bit, php_wxIsPlatform64Bit, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsPlatformLittleEndian, php_wxIsPlatformLittleEndian, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetCpuArchitectureName, php_wxGetCpuArchitectureName, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetNativeCpuArchitectureName, php_wxGetNativeCpuArchitectureName, arginfo_tmp_placeholder)
    PHP_FALIAS(wxGetProcessId, php_wxGetProcessId, arginfo_tmp_placeholder)
    PHP_FALIAS(wxKill, php_wxKill, arginfo_tmp_placeholder)
    PHP_FALIAS(wxShell, php_wxShell, arginfo_tmp_placeholder)
    PHP_FALIAS(wxShutdown, php_wxShutdown, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMicroSleep, php_wxMicroSleep, arginfo_tmp_placeholder)
    PHP_FALIAS(wxMilliSleep, php_wxMilliSleep, arginfo_tmp_placeholder)
    PHP_FALIAS(wxNow, php_wxNow, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSleep, php_wxSleep, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDecToHex, php_wxDecToHex, arginfo_tmp_placeholder)
    PHP_FALIAS(wxHexToDec, php_wxHexToDec, arginfo_tmp_placeholder)
    PHP_FALIAS(wxIsEmpty, php_wxIsEmpty, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTmemchr, php_wxTmemchr, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTmemcmp, php_wxTmemcmp, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTmemcpy, php_wxTmemcpy, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTmemmove, php_wxTmemmove, arginfo_tmp_placeholder)
    PHP_FALIAS(wxTmemset, php_wxTmemset, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSetlocale, php_wxSetlocale, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrlen, php_wxStrlen, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrnlen, php_wxStrnlen, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrdup, php_wxStrdup, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrcpy, php_wxStrcpy, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrncpy, php_wxStrncpy, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrlcpy, php_wxStrlcpy, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrcat, php_wxStrcat, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrncat, php_wxStrncat, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrxfrm, php_wxStrxfrm, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrstr, php_wxStrstr, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrchr, php_wxStrchr, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrrchr, php_wxStrrchr, arginfo_tmp_placeholder)
    PHP_FALIAS(wxStrpbrk, php_wxStrpbrk, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRemove, php_wxRemove, arginfo_tmp_placeholder)
    PHP_FALIAS(wxRename, php_wxRename, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAtoi, php_wxAtoi, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAtol, php_wxAtol, arginfo_tmp_placeholder)
    PHP_FALIAS(wxAtof, php_wxAtof, arginfo_tmp_placeholder)
    PHP_FALIAS(wxSystem, php_wxSystem, arginfo_tmp_placeholder)
    PHP_FALIAS(wxDynamicCast, php_wxDynamicCast, arginfo_tmp_placeholder)
...
PHP_RINIT_FUNCTION(php_wxWidgets)
{
    ...
    if(objects_intialized < 1)
    {
        ...
        object_init_ex(&wxphpGlobalConsts.z_wxNullBitmap, php_wxBitmap_entry);
        Z_wxBitmap_P(&wxphpGlobalConsts.z_wxNullBitmap)->native_object = (wxBitmap_php*) &wxNullBitmap;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullBitmap", wxphpGlobalConsts.z_wxNullBitmap, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullFont, php_wxFont_entry);
        Z_wxFont_P(&wxphpGlobalConsts.z_wxNullFont)->native_object = (wxFont_php*) &wxNullFont;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullFont", wxphpGlobalConsts.z_wxNullFont, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNORMAL_FONT, php_wxFont_entry);
        Z_wxFont_P(&wxphpGlobalConsts.z_wxNORMAL_FONT)->native_object = (wxFont_php*) wxNORMAL_FONT;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNORMAL_FONT", wxphpGlobalConsts.z_wxNORMAL_FONT, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxSMALL_FONT, php_wxFont_entry);
        Z_wxFont_P(&wxphpGlobalConsts.z_wxSMALL_FONT)->native_object = (wxFont_php*) wxSMALL_FONT;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxSMALL_FONT", wxphpGlobalConsts.z_wxSMALL_FONT, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxITALIC_FONT, php_wxFont_entry);
        Z_wxFont_P(&wxphpGlobalConsts.z_wxITALIC_FONT)->native_object = (wxFont_php*) wxITALIC_FONT;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxITALIC_FONT", wxphpGlobalConsts.z_wxITALIC_FONT, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxSWISS_FONT, php_wxFont_entry);
        Z_wxFont_P(&wxphpGlobalConsts.z_wxSWISS_FONT)->native_object = (wxFont_php*) wxSWISS_FONT;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxSWISS_FONT", wxphpGlobalConsts.z_wxSWISS_FONT, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTheFontList, php_wxFontList_entry);
        Z_wxFontList_P(&wxphpGlobalConsts.z_wxTheFontList)->native_object = (wxFontList_php*) wxTheFontList;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTheFontList", wxphpGlobalConsts.z_wxTheFontList, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullAnimation, php_wxAnimation_entry);
        Z_wxAnimation_P(&wxphpGlobalConsts.z_wxNullAnimation)->native_object = (wxAnimation_php*) &wxNullAnimation;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullAnimation", wxphpGlobalConsts.z_wxNullAnimation, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullBrush, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxNullBrush)->native_object = (wxBrush_php*) &wxNullBrush;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullBrush", wxphpGlobalConsts.z_wxNullBrush, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLUE_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxBLUE_BRUSH)->native_object = (wxBrush_php*) wxBLUE_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLUE_BRUSH", wxphpGlobalConsts.z_wxBLUE_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxGREEN_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxGREEN_BRUSH)->native_object = (wxBrush_php*) wxGREEN_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxGREEN_BRUSH", wxphpGlobalConsts.z_wxGREEN_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxYELLOW_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxYELLOW_BRUSH)->native_object = (wxBrush_php*) wxYELLOW_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxYELLOW_BRUSH", wxphpGlobalConsts.z_wxYELLOW_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxWHITE_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxWHITE_BRUSH)->native_object = (wxBrush_php*) wxWHITE_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxWHITE_BRUSH", wxphpGlobalConsts.z_wxWHITE_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLACK_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxBLACK_BRUSH)->native_object = (wxBrush_php*) wxBLACK_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLACK_BRUSH", wxphpGlobalConsts.z_wxBLACK_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxGREY_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxGREY_BRUSH)->native_object = (wxBrush_php*) wxGREY_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxGREY_BRUSH", wxphpGlobalConsts.z_wxGREY_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxMEDIUM_GREY_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxMEDIUM_GREY_BRUSH)->native_object = (wxBrush_php*) wxMEDIUM_GREY_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxMEDIUM_GREY_BRUSH", wxphpGlobalConsts.z_wxMEDIUM_GREY_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxLIGHT_GREY_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxLIGHT_GREY_BRUSH)->native_object = (wxBrush_php*) wxLIGHT_GREY_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxLIGHT_GREY_BRUSH", wxphpGlobalConsts.z_wxLIGHT_GREY_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTRANSPARENT_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxTRANSPARENT_BRUSH)->native_object = (wxBrush_php*) wxTRANSPARENT_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTRANSPARENT_BRUSH", wxphpGlobalConsts.z_wxTRANSPARENT_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxCYAN_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxCYAN_BRUSH)->native_object = (wxBrush_php*) wxCYAN_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxCYAN_BRUSH", wxphpGlobalConsts.z_wxCYAN_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxRED_BRUSH, php_wxBrush_entry);
        Z_wxBrush_P(&wxphpGlobalConsts.z_wxRED_BRUSH)->native_object = (wxBrush_php*) wxRED_BRUSH;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxRED_BRUSH", wxphpGlobalConsts.z_wxRED_BRUSH, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullColour, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxNullColour)->native_object = (wxColour_php*) &wxNullColour;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullColour", wxphpGlobalConsts.z_wxNullColour, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLACK, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxBLACK)->native_object = (wxColour_php*) wxBLACK;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLACK", wxphpGlobalConsts.z_wxBLACK, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLUE, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxBLUE)->native_object = (wxColour_php*) wxBLUE;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLUE", wxphpGlobalConsts.z_wxBLUE, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxCYAN, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxCYAN)->native_object = (wxColour_php*) wxCYAN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxCYAN", wxphpGlobalConsts.z_wxCYAN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxGREEN, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxGREEN)->native_object = (wxColour_php*) wxGREEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxGREEN", wxphpGlobalConsts.z_wxGREEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxYELLOW, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxYELLOW)->native_object = (wxColour_php*) wxYELLOW;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxYELLOW", wxphpGlobalConsts.z_wxYELLOW, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxLIGHT_GREY, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxLIGHT_GREY)->native_object = (wxColour_php*) wxLIGHT_GREY;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxLIGHT_GREY", wxphpGlobalConsts.z_wxLIGHT_GREY, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxRED, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxRED)->native_object = (wxColour_php*) wxRED;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxRED", wxphpGlobalConsts.z_wxRED, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxWHITE, php_wxColour_entry);
        Z_wxColour_P(&wxphpGlobalConsts.z_wxWHITE)->native_object = (wxColour_php*) wxWHITE;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxWHITE", wxphpGlobalConsts.z_wxWHITE, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullCursor, php_wxCursor_entry);
        Z_wxCursor_P(&wxphpGlobalConsts.z_wxNullCursor)->native_object = (wxCursor_php*) &wxNullCursor;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullCursor", wxphpGlobalConsts.z_wxNullCursor, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxSTANDARD_CURSOR, php_wxCursor_entry);
        Z_wxCursor_P(&wxphpGlobalConsts.z_wxSTANDARD_CURSOR)->native_object = (wxCursor_php*) wxSTANDARD_CURSOR;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxSTANDARD_CURSOR", wxphpGlobalConsts.z_wxSTANDARD_CURSOR, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxHOURGLASS_CURSOR, php_wxCursor_entry);
        Z_wxCursor_P(&wxphpGlobalConsts.z_wxHOURGLASS_CURSOR)->native_object = (wxCursor_php*) wxHOURGLASS_CURSOR;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxHOURGLASS_CURSOR", wxphpGlobalConsts.z_wxHOURGLASS_CURSOR, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxCROSS_CURSOR, php_wxCursor_entry);
        Z_wxCursor_P(&wxphpGlobalConsts.z_wxCROSS_CURSOR)->native_object = (wxCursor_php*) wxCROSS_CURSOR;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxCROSS_CURSOR", wxphpGlobalConsts.z_wxCROSS_CURSOR, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxFormatInvalid, php_wxDataFormat_entry);
        Z_wxDataFormat_P(&wxphpGlobalConsts.z_wxFormatInvalid)->native_object = (wxDataFormat_php*) &wxFormatInvalid;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxFormatInvalid", wxphpGlobalConsts.z_wxFormatInvalid, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxDefaultSpan, php_wxGBSpan_entry);
        Z_wxGBSpan_P(&wxphpGlobalConsts.z_wxDefaultSpan)->native_object = (wxGBSpan_php*) &wxDefaultSpan;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxDefaultSpan", wxphpGlobalConsts.z_wxDefaultSpan, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxDefaultPosition, php_wxPoint_entry);
        Z_wxPoint_P(&wxphpGlobalConsts.z_wxDefaultPosition)->native_object = (wxPoint_php*) &wxDefaultPosition;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxDefaultPosition", wxphpGlobalConsts.z_wxDefaultPosition, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTheColourDatabase, php_wxColourDatabase_entry);
        Z_wxColourDatabase_P(&wxphpGlobalConsts.z_wxTheColourDatabase)->native_object = (wxColourDatabase_php*) wxTheColourDatabase;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTheColourDatabase", wxphpGlobalConsts.z_wxTheColourDatabase, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxDefaultSize, php_wxSize_entry);
        Z_wxSize_P(&wxphpGlobalConsts.z_wxDefaultSize)->native_object = (wxSize_php*) &wxDefaultSize;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxDefaultSize", wxphpGlobalConsts.z_wxDefaultSize, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullGraphicsMatrix, php_wxGraphicsMatrix_entry);
        Z_wxGraphicsMatrix_P(&wxphpGlobalConsts.z_wxNullGraphicsMatrix)->native_object = (wxGraphicsMatrix_php*) &wxNullGraphicsMatrix;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullGraphicsMatrix", wxphpGlobalConsts.z_wxNullGraphicsMatrix, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullIcon, php_wxIcon_entry);
        Z_wxIcon_P(&wxphpGlobalConsts.z_wxNullIcon)->native_object = (wxIcon_php*) &wxNullIcon;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullIcon", wxphpGlobalConsts.z_wxNullIcon, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullIconBundle, php_wxIconBundle_entry);
        Z_wxIconBundle_P(&wxphpGlobalConsts.z_wxNullIconBundle)->native_object = (wxIconBundle_php*) &wxNullIconBundle;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullIconBundle", wxphpGlobalConsts.z_wxNullIconBundle, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullImage, php_wxImage_entry);
        Z_wxImage_P(&wxphpGlobalConsts.z_wxNullImage)->native_object = (wxImage_php*) &wxNullImage;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullImage", wxphpGlobalConsts.z_wxNullImage, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullPalette, php_wxPalette_entry);
        Z_wxPalette_P(&wxphpGlobalConsts.z_wxNullPalette)->native_object = (wxPalette_php*) &wxNullPalette;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullPalette", wxphpGlobalConsts.z_wxNullPalette, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxNullPen, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxNullPen)->native_object = (wxPen_php*) &wxNullPen;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxNullPen", wxphpGlobalConsts.z_wxNullPen, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxRED_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxRED_PEN)->native_object = (wxPen_php*) wxRED_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxRED_PEN", wxphpGlobalConsts.z_wxRED_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLUE_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxBLUE_PEN)->native_object = (wxPen_php*) wxBLUE_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLUE_PEN", wxphpGlobalConsts.z_wxBLUE_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxCYAN_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxCYAN_PEN)->native_object = (wxPen_php*) wxCYAN_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxCYAN_PEN", wxphpGlobalConsts.z_wxCYAN_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxGREEN_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxGREEN_PEN)->native_object = (wxPen_php*) wxGREEN_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxGREEN_PEN", wxphpGlobalConsts.z_wxGREEN_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxYELLOW_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxYELLOW_PEN)->native_object = (wxPen_php*) wxYELLOW_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxYELLOW_PEN", wxphpGlobalConsts.z_wxYELLOW_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLACK_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxBLACK_PEN)->native_object = (wxPen_php*) wxBLACK_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLACK_PEN", wxphpGlobalConsts.z_wxBLACK_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxWHITE_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxWHITE_PEN)->native_object = (wxPen_php*) wxWHITE_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxWHITE_PEN", wxphpGlobalConsts.z_wxWHITE_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTRANSPARENT_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxTRANSPARENT_PEN)->native_object = (wxPen_php*) wxTRANSPARENT_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTRANSPARENT_PEN", wxphpGlobalConsts.z_wxTRANSPARENT_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxBLACK_DASHED_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxBLACK_DASHED_PEN)->native_object = (wxPen_php*) wxBLACK_DASHED_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxBLACK_DASHED_PEN", wxphpGlobalConsts.z_wxBLACK_DASHED_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxGREY_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxGREY_PEN)->native_object = (wxPen_php*) wxGREY_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxGREY_PEN", wxphpGlobalConsts.z_wxGREY_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxMEDIUM_GREY_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxMEDIUM_GREY_PEN)->native_object = (wxPen_php*) wxMEDIUM_GREY_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxMEDIUM_GREY_PEN", wxphpGlobalConsts.z_wxMEDIUM_GREY_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxLIGHT_GREY_PEN, php_wxPen_entry);
        Z_wxPen_P(&wxphpGlobalConsts.z_wxLIGHT_GREY_PEN)->native_object = (wxPen_php*) wxLIGHT_GREY_PEN;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxLIGHT_GREY_PEN", wxphpGlobalConsts.z_wxLIGHT_GREY_PEN, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxThePenList, php_wxPenList_entry);
        Z_wxPenList_P(&wxphpGlobalConsts.z_wxThePenList)->native_object = (wxPenList_php*) wxThePenList;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxThePenList", wxphpGlobalConsts.z_wxThePenList, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTLI_FIRST, php_wxTreeListItem_entry);
        Z_wxTreeListItem_P(&wxphpGlobalConsts.z_wxTLI_FIRST)->native_object = (wxTreeListItem_php*) &wxTLI_FIRST;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTLI_FIRST", wxphpGlobalConsts.z_wxTLI_FIRST, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxTLI_LAST, php_wxTreeListItem_entry);
        Z_wxTreeListItem_P(&wxphpGlobalConsts.z_wxTLI_LAST)->native_object = (wxTreeListItem_php*) &wxTLI_LAST;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxTLI_LAST", wxphpGlobalConsts.z_wxTLI_LAST, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxDefaultValidator, php_wxValidator_entry);
        Z_wxValidator_P(&wxphpGlobalConsts.z_wxDefaultValidator)->native_object = (wxValidator_php*) &wxDefaultValidator;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxDefaultValidator", wxphpGlobalConsts.z_wxDefaultValidator, CONST_CS | CONST_PERSISTENT);

        object_init_ex(&wxphpGlobalConsts.z_wxDefaultVideoMode, php_wxVideoMode_entry);
        Z_wxVideoMode_P(&wxphpGlobalConsts.z_wxDefaultVideoMode)->native_object = (wxVideoMode_php*) &wxDefaultVideoMode;
        wxPHP_REGISTER_OBJECT_CONSTANT("wxDefaultVideoMode", wxphpGlobalConsts.z_wxDefaultVideoMode, CONST_CS | CONST_PERSISTENT);
...
{
    php_wxBitmap_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullBitmap));
    php_wxFont_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullFont));
    php_wxFont_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNORMAL_FONT));
    php_wxFont_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxSMALL_FONT));
    php_wxFont_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxITALIC_FONT));
    php_wxFont_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxSWISS_FONT));
    php_wxFontList_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTheFontList));
    php_wxAnimation_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullAnimation));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullBrush));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLUE_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxGREEN_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxYELLOW_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxWHITE_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLACK_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxGREY_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxMEDIUM_GREY_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxLIGHT_GREY_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTRANSPARENT_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxCYAN_BRUSH));
    php_wxBrush_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxRED_BRUSH));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullColour));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLACK));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLUE));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxCYAN));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxGREEN));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxYELLOW));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxLIGHT_GREY));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxRED));
    php_wxColour_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxWHITE));
    php_wxCursor_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullCursor));
    php_wxCursor_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxSTANDARD_CURSOR));
    php_wxCursor_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxHOURGLASS_CURSOR));
    php_wxCursor_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxCROSS_CURSOR));
    php_wxDataFormat_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxFormatInvalid));
    php_wxGBSpan_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxDefaultSpan));
    php_wxPoint_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxDefaultPosition));
    php_wxColourDatabase_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTheColourDatabase));
    php_wxSize_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxDefaultSize));
    php_wxGraphicsMatrix_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullGraphicsMatrix));
    php_wxIcon_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullIcon));
    php_wxIconBundle_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullIconBundle));
    php_wxImage_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullImage));
    php_wxPalette_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullPalette));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxNullPen));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxRED_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLUE_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxCYAN_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxGREEN_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxYELLOW_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLACK_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxWHITE_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTRANSPARENT_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxBLACK_DASHED_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxGREY_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxMEDIUM_GREY_PEN));
    php_wxPen_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxLIGHT_GREY_PEN));
    php_wxPenList_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxThePenList));
    php_wxTreeListItem_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTLI_FIRST));
    php_wxTreeListItem_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxTLI_LAST));
    php_wxValidator_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxDefaultValidator));
    php_wxVideoMode_free(Z_OBJ_P(&wxphpGlobalConsts.z_wxDefaultVideoMode));
...
PHP_MINIT_FUNCTION(php_wxWidgets)
{
    ...
    REGISTER_LONG_CONSTANT("WXK_BROWSER_BACK", WXK_BROWSER_BACK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_FAVORITES", WXK_BROWSER_FAVORITES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_FORWARD", WXK_BROWSER_FORWARD, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_HOME", WXK_BROWSER_HOME, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_REFRESH", WXK_BROWSER_REFRESH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_SEARCH", WXK_BROWSER_SEARCH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_BROWSER_STOP", WXK_BROWSER_STOP, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("WXK_MEDIA_NEXT_TRACK", WXK_MEDIA_NEXT_TRACK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_MEDIA_PLAY_PAUSE", WXK_MEDIA_PLAY_PAUSE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_MEDIA_PREV_TRACK", WXK_MEDIA_PREV_TRACK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_MEDIA_STOP", WXK_MEDIA_STOP, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("WXK_VOLUME_DOWN", WXK_VOLUME_DOWN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_VOLUME_MUTE", WXK_VOLUME_MUTE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WXK_VOLUME_UP", WXK_VOLUME_UP, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("WXPHP_FD_EVENT_CB", WXPHP_FD_EVENT_CB, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_ANY_VALUE_BUFFER_SIZE", WX_ANY_VALUE_BUFFER_SIZE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_CORE_PROFILE", WX_GL_CORE_PROFILE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_DEBUG", WX_GL_DEBUG, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_ES2", WX_GL_ES2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_FORWARD_COMPAT", WX_GL_FORWARD_COMPAT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_FRAMEBUFFER_SRGB", WX_GL_FRAMEBUFFER_SRGB, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_LOSE_ON_RESET", WX_GL_LOSE_ON_RESET, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_MAJOR_VERSION", WX_GL_MAJOR_VERSION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_MINOR_VERSION", WX_GL_MINOR_VERSION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_NO_RESET_NOTIFY", WX_GL_NO_RESET_NOTIFY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_RELEASE_FLUSH", WX_GL_RELEASE_FLUSH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_RELEASE_NONE", WX_GL_RELEASE_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_RESET_ISOLATION", WX_GL_RESET_ISOLATION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("WX_GL_ROBUST_ACCESS", WX_GL_ROBUST_ACCESS, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxACC_SELF", 0, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxBITNESS_32", wxBITNESS_32, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxBITNESS_64", wxBITNESS_64, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxBITNESS_INVALID", wxBITNESS_INVALID, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxBITNESS_MAX", wxBITNESS_MAX, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxCLRP_SHOW_ALPHA", 0x0010, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxCLRP_SHOW_LABEL", 0x0008, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxCMD_LINE_HIDDEN", wxCMD_LINE_HIDDEN, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxCOMPOSITION_DIFF", wxCOMPOSITION_DIFF, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxCONTROL_NONE", wxCONTROL_NONE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxDD_MULTIPLE", 0x0400, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxDD_NEW_DIR_BUTTON", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxDD_SHOW_HIDDEN", 0x0001, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxDF_PNG", wxDF_PNG, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxDIRCTRL_DEFAULT_STYLE", wxDIRCTRL_DEFAULT_STYLE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVENT_SOURCE_ALL", wxEVENT_SOURCE_ALL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVENT_SOURCE_EXCEPTION", wxEVENT_SOURCE_EXCEPTION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVENT_SOURCE_INPUT", wxEVENT_SOURCE_INPUT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVENT_SOURCE_OUTPUT", wxEVENT_SOURCE_OUTPUT, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxFD_SHOW_HIDDEN", wxFD_SHOW_HIDDEN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFH_PATH_SHOW_ALWAYS", wxFH_PATH_SHOW_ALWAYS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFH_PATH_SHOW_IF_DIFFERENT", wxFH_PATH_SHOW_IF_DIFFERENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFH_PATH_SHOW_NEVER", wxFH_PATH_SHOW_NEVER, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxFILTER_SPACE", wxFILTER_SPACE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFILTER_XDIGITS", wxFILTER_XDIGITS, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_EXTRABOLD", wxFONTWEIGHT_EXTRABOLD, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_EXTRAHEAVY", wxFONTWEIGHT_EXTRAHEAVY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_EXTRALIGHT", wxFONTWEIGHT_EXTRALIGHT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_HEAVY", wxFONTWEIGHT_HEAVY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_INVALID", wxFONTWEIGHT_INVALID, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_MEDIUM", wxFONTWEIGHT_MEDIUM, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_NORMAL", wxFONTWEIGHT_NORMAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_SEMIBOLD", wxFONTWEIGHT_SEMIBOLD, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxFONTWEIGHT_THIN", wxFONTWEIGHT_THIN, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxGA_PROGRESS", 0x0010, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGA_SMOOTH", wxGA_SMOOTH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGA_TEXT", 0x0040, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGA_VERTICAL", wxGA_VERTICAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGRADIENT_LINEAR", wxGRADIENT_LINEAR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGRADIENT_NONE", wxGRADIENT_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxGRADIENT_RADIAL", wxGRADIENT_RADIAL, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxHD_BITMAP_ON_RIGHT", wxHD_BITMAP_ON_RIGHT, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxHLB_DEFAULT_STYLE", wxBORDER_SUNKEN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxHLB_MULTIPLE", wxLB_MULTIPLE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxIMAGE_ALPHA_BLEND_COMPOSE", wxIMAGE_ALPHA_BLEND_COMPOSE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxIMAGE_ALPHA_BLEND_OVER", wxIMAGE_ALPHA_BLEND_OVER, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPEN_QUALITY_DEFAULT", wxPEN_QUALITY_DEFAULT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPEN_QUALITY_HIGH", wxPEN_QUALITY_HIGH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPEN_QUALITY_LOW", wxPEN_QUALITY_LOW, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_BASE_DEC", 10L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_BASE_HEX", 16L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_BASE_HEXL", 32L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_BASE_OCT", 8L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_BOLD_MODIFIED", wxPG_BOLD_MODIFIED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_COLOUR_CUSTOM", 0xFFFFFF, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_COLOUR_WEB_BASE", 0x10000, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_COMPOSITE_FRAGMENT", wxPG_COMPOSITE_FRAGMENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_DESCRIPTION", wxPG_DESCRIPTION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_DONT_RECURSE", wxPG_DONT_RECURSE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_EDITABLE_VALUE", wxPG_EDITABLE_VALUE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_EX_ALWAYS_ALLOW_FOCUS", wxPG_EX_ALWAYS_ALLOW_FOCUS, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_EX_WINDOW_PGMAN_STYLE_MASK", wxPG_EX_WINDOW_PGMAN_STYLE_MASK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_EX_WINDOW_PG_STYLE_MASK", wxPG_EX_WINDOW_PG_STYLE_MASK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_EX_WINDOW_STYLE_MASK", wxPG_EX_WINDOW_STYLE_MASK, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_FORCE", wxPG_FORCE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_FULL_VALUE", wxPG_FULL_VALUE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_INC_ATTRIBUTES", wxPG_INC_ATTRIBUTES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_INVALID_VALUE", INT_MAX, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_KEEP_STRUCTURE", wxPG_KEEP_STRUCTURE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_PREFIX_0x", 1L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PREFIX_DOLLAR_SIGN", 2L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PREFIX_NONE", 0L, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROGRAMMATIC_VALUE", wxPG_PROGRAMMATIC_VALUE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROPERTY_SPECIFIC", wxPG_PROPERTY_SPECIFIC, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROPERTY_VALIDATION_ERROR_MESSAGE", wxPG_PROPERTY_VALIDATION_ERROR_MESSAGE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROPERTY_VALIDATION_SATURATE", wxPG_PROPERTY_VALIDATION_SATURATE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROPERTY_VALIDATION_WRAP", wxPG_PROPERTY_VALIDATION_WRAP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_ACTIVE_BTN", wxPG_PROP_CLASS_SPECIFIC_1, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_PROP_PASSWORD", wxPG_PROP_CLASS_SPECIFIC_2, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_PROP_SHOW_FULL_FILENAME", wxPG_PROP_CLASS_SPECIFIC_1, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_STATIC_CHOICES", wxPG_PROP_CLASS_SPECIFIC_1, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_TRANSLATE_CUSTOM", wxPG_PROP_CLASS_SPECIFIC_1, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_USES_COMMON_VALUE", wxPG_PROP_USES_COMMON_VALUE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_USE_CHECKBOX", wxPG_PROP_CLASS_SPECIFIC_1, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_USE_DCC", wxPG_PROP_CLASS_SPECIFIC_2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_PROP_WAS_MODIFIED", wxPG_PROP_WAS_MODIFIED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_RECURSE", wxPG_RECURSE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_RECURSE_STARTS", wxPG_RECURSE_STARTS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_REPORT_ERROR", wxPG_REPORT_ERROR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_SETVAL_AGGREGATED", wxPG_SETVAL_AGGREGATED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_SETVAL_BY_USER", wxPG_SETVAL_BY_USER, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_SETVAL_FROM_PARENT", wxPG_SETVAL_FROM_PARENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_SETVAL_REFRESH_EDITOR", wxPG_SETVAL_REFRESH_EDITOR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_SORT_TOP_LEVEL_ONLY", wxPG_SORT_TOP_LEVEL_ONLY, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_UNEDITABLE_COMPOSITE_FRAGMENT", wxPG_UNEDITABLE_COMPOSITE_FRAGMENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPG_VALUE_IS_CURRENT", wxPG_VALUE_IS_CURRENT, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPG_WINDOW_STYLE_MASK", wxPG_WINDOW_STYLE_MASK, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPORT_QT", wxPORT_QT, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPOWER_RESOURCE_SCREEN", wxPOWER_RESOURCE_SCREEN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxPOWER_RESOURCE_SYSTEM", wxPOWER_RESOURCE_SYSTEM, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxPU_CONTAINS_CONTROLS", 0x0001, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_COLOUR", wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_COLOUR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_GRADIENT_COLOUR", wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_GRADIENT_COLOUR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_GRADIENT_TOP_COLOUR", wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_GRADIENT_TOP_COLOUR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_TOP_COLOUR", wxRIBBON_ART_BUTTON_BAR_LABEL_HIGHLIGHT_TOP_COLOUR, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_PANEL_HOVER_BORDER_COLOUR", wxRIBBON_ART_PANEL_HOVER_BORDER_COLOUR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_PANEL_HOVER_BORDER_GRADIENT_COLOUR", wxRIBBON_ART_PANEL_HOVER_BORDER_GRADIENT_COLOUR, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_TAB_ACTIVE_LABEL_COLOUR", wxRIBBON_ART_TAB_ACTIVE_LABEL_COLOUR, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_ART_TAB_HOVER_LABEL_COLOUR", wxRIBBON_ART_TAB_HOVER_LABEL_COLOUR, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_ALWAYS_SHOW_TABS", wxRIBBON_BAR_ALWAYS_SHOW_TABS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_DEFAULT_STYLE", wxRIBBON_BAR_DEFAULT_STYLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_EXPANDED", wxRIBBON_BAR_EXPANDED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_FLOW_HORIZONTAL", wxRIBBON_BAR_FLOW_HORIZONTAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_FLOW_VERTICAL", wxRIBBON_BAR_FLOW_VERTICAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_FOLDBAR_STYLE", wxRIBBON_BAR_FOLDBAR_STYLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_MINIMIZED", wxRIBBON_BAR_MINIMIZED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_PINNED", wxRIBBON_BAR_PINNED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_HELP_BUTTON", wxRIBBON_BAR_SHOW_HELP_BUTTON, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_PAGE_ICONS", wxRIBBON_BAR_SHOW_PAGE_ICONS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_PAGE_LABELS", wxRIBBON_BAR_SHOW_PAGE_LABELS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_PANEL_EXT_BUTTONS", wxRIBBON_BAR_SHOW_PANEL_EXT_BUTTONS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_PANEL_MINIMISE_BUTTONS", wxRIBBON_BAR_SHOW_PANEL_MINIMISE_BUTTONS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BAR_SHOW_TOGGLE_BUTTON", wxRIBBON_BAR_SHOW_TOGGLE_BUTTON, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_BUTTONBAR_BUTTON_ACTIVE_MASK", wxRIBBON_BUTTONBAR_BUTTON_ACTIVE_MASK, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_DEFAULT_STYLE", wxRIBBON_PANEL_DEFAULT_STYLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_EXT_BUTTON", wxRIBBON_PANEL_EXT_BUTTON, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_FLEXIBLE", wxRIBBON_PANEL_FLEXIBLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_MINIMISE_BUTTON", wxRIBBON_PANEL_MINIMISE_BUTTON, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_NO_AUTO_MINIMISE", wxRIBBON_PANEL_NO_AUTO_MINIMISE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxRIBBON_PANEL_STRETCH", wxRIBBON_PANEL_STRETCH, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxRICHTEXT_HANDLER_USE_CSS", 0x1000, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_ABL_BLOCK", 8, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_CHARACTER", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_COMMENT", 10, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_END", 9, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_IDENTIFIER", 7, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_LINECOMMENT", 12, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_NUMBER", wxSTC_ABL_NUMBER, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_OPERATOR", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_PREPROCESSOR", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_STRING", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_TASKMARKER", 11, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ABL_WORD", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_AC_COMMAND", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_AC_DOUBLECLICK", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_AC_FILLUP", wxSTC_AC_FILLUP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_AC_NEWLINE", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_AC_TAB", 3, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_ANNOTATION_INDENTED", 3, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_AUTOMATICFOLD_SHOW", 0x0001, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_DEFINEDEF", 24, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_DOMDEF", 21, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_FUNCDEF", 22, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_FUNCTION", 20, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_OBJECTDEF", 23, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_TABLEDEF", 18, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_TABLESQL", 19, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD3", 11, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD4", 12, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD5", 13, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD6", 14, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD7", 15, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD8", 16, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BAAN_WORD9", 17, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_COMMENT", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_ENTRY", wxSTC_BIBTEX_ENTRY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_KEY", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_PARAMETER", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_UNKNOWN_ENTRY", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_BIBTEX_VALUE", 5, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_CASE_CAMEL", 3, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_CHARSET_OEM866", 866, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_COFFEESCRIPT_INSTANCEPROPERTY", 25, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_C_ESCAPESEQUENCE", 27, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_C_TASKMARKER", 26, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_COMMENT", wxSTC_DMIS_COMMENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_KEYWORD", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_LABEL", 9, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_MAJORWORD", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_MINORWORD", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_NUMBER", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_STRING", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_UNSUPPORTED_MAJOR", 7, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_DMIS_UNSUPPORTED_MINOR", 8, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_EDGE_MULTILINE", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDGE_NONE", wxSTC_EDGE_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_BADSEGMENT", 8, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_SEGMENTEND", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_SEGMENTSTART", wxSTC_EDI_SEGMENTSTART, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_SEP_COMPOSITE", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_SEP_ELEMENT", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_SEP_RELEASE", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_UNA", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_EDI_UNH", 7, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ESCSEQ", 23, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ESCSEQ_UNKNOWN", 24, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BLACK", 40, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BLUE", 44, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BRIGHT_BLUE", 52, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BRIGHT_CYAN", 54, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BRIGHT_GREEN", 50, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BRIGHT_MAGENTA", 53, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BRIGHT_RED", 49, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_BROWN", 43, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_CYAN", 46, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_DARK_GRAY", 48, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_GRAY", 47, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_GREEN", 42, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_MAGENTA", 45, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_RED", 41, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_WHITE", 55, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_ERR_ES_YELLOW", 51, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_FOLDDISPLAYTEXT_BOXED", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_FOLDDISPLAYTEXT_HIDDEN", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_FOLDDISPLAYTEXT_STANDARD", wxSTC_FOLDDISPLAYTEXT_STANDARD, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_FOLDFLAG_LINESTATE", 0x0080, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_HEX_ADDRESSFIELD_UNKNOWN", 10, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_BYTECOUNT", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_BYTECOUNT_WRONG", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_CHECKSUM", 16, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_CHECKSUM_WRONG", 17, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DATAADDRESS", 7, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DATA_EMPTY", 15, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DATA_EVEN", 13, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DATA_ODD", 12, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DATA_UNKNOWN", 14, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_EXTENDEDADDRESS", 11, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_GARBAGE", 18, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_NOADDRESS", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_RECCOUNT", 8, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_RECSTART", wxSTC_HEX_RECSTART, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_RECTYPE", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_RECTYPE_UNKNOWN", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_HEX_STARTADDRESS", 9, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_IDLESTYLING_AFTERVISIBLE", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_IDLESTYLING_ALL", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_IDLESTYLING_NONE", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_IDLESTYLING_TOVISIBLE", wxSTC_IDLESTYLING_TOVISIBLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_IME_INLINE", wxSTC_IME_INLINE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_IME_WINDOWED", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC0_MASK", 0x20, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC1_MASK", 0x40, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC2_MASK", 0x80, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDICFLAG_VALUEFORE", wxSTC_INDICFLAG_VALUEFORE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDICS_MASK", 0xE0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDICVALUEBIT", 0x1000000, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDICVALUEMASK", 0xFFFFFF, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_COMPOSITIONTHIN", 15, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_FULLBOX", 16, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_HIDDEN", wxSTC_INDIC_HIDDEN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_IME", 32, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_IME_MAX", 35, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_POINT", 18, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_POINTCHARACTER", 19, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_INDIC_TEXTFORE", 17, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_JSON_BLOCKCOMMENT", 7, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_COMPACTIRI", 10, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_ERROR", 13, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_ESCAPESEQUENCE", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_KEYWORD", 11, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_LDKEYWORD", 12, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_LINECOMMENT", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_NUMBER", wxSTC_JSON_NUMBER, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_OPERATOR", 8, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_PROPERTYNAME", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_STRING", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_STRINGEOL", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_JSON_URI", 9, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_ALT", wxSTC_KEYMOD_ALT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_CTRL", wxSTC_KEYMOD_CTRL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_META", 16, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_NORM", wxSTC_KEYMOD_NORM, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_SHIFT", wxSTC_KEYMOD_SHIFT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_KEYMOD_SUPER", wxSTC_KEYMOD_SUPER, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_KIX_COMMENTSTREAM", 10, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_AS", 113, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_BIBTEX", 116, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_DMIS", 114, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_LEX_ECL", 105, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_LEX_EDIFACT", 121, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_IHEX", 118, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_LEX_INNOSETUP", wxSTC_LEX_INNOSETUP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_LEX_JSON", 120, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_REGISTRY", 115, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_SREC", 117, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_LEX_TEHEX", 119, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_MARGIN_COLOUR", 6, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_MOD_CHANGETABSTOPS", 0x200000, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_MOD_INSERTCHECK", 0x100000, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_MULTIAUTOC_EACH", wxSTC_MULTIAUTOC_EACH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_MULTIAUTOC_ONCE", 0, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_PHASES_MULTIPLE", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_PHASES_ONE", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_PHASES_TWO", wxSTC_PHASES_TWO, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_POPUP_ALL", wxSTC_POPUP_ALL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_POPUP_NEVER", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_POPUP_TEXT", 2, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_REG_ADDEDKEY", 6, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_COMMENT", wxSTC_REG_COMMENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_DELETEDKEY", 7, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_ESCAPED", 8, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_HEXDIGIT", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_KEYPATH_GUID", 9, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_OPERATOR", 12, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_PARAMETER", 11, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_STRING", 3, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_STRING_GUID", 10, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_VALUENAME", 2, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_REG_VALUETYPE", 5, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_RUST_BYTECHARACTER", 23, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_RUST_BYTESTRING", 21, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_RUST_BYTESTRINGR", 22, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_SQL_QOPERATOR", 24, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_STATUS_WARN_REGEX", 1001, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_STATUS_WARN_START", 1000, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_STYLE_FOLDDISPLAYTEXT", 39, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_TD_LONGARROW", 0, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_TD_STRIKEOUT", wxSTC_TD_STRIKEOUT, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_VHDL_BLOCK_COMMENT", 15, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_VS_NONE", wxSTC_VS_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_VS_NOWRAPLINESTART", 4, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_VS_RECTANGULARSELECTION", wxSTC_VS_RECTANGULARSELECTION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_VS_USERACCESSIBLE", wxSTC_VS_USERACCESSIBLE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_V_COMMENT_WORD", 20, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_V_INOUT", 23, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_V_INPUT", 21, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_V_OUTPUT", 22, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSTC_V_PORT_CONNECT", 24, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_WRAP_WHITESPACE", 3, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSTC_WS_VISIBLEONLYININDENT", 3, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSVG_SHAPE_RENDERING_AUTO", wxSVG_SHAPE_RENDERING_AUTO, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSVG_SHAPE_RENDERING_CRISP_EDGES", wxSVG_SHAPE_RENDERING_CRISP_EDGES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSVG_SHAPE_RENDERING_GEOMETRIC_PRECISION", wxSVG_SHAPE_RENDERING_GEOMETRIC_PRECISION, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSVG_SHAPE_RENDERING_OPTIMISE_SPEED", wxSVG_SHAPE_RENDERING_OPTIMISE_SPEED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSVG_SHAPE_RENDERING_OPTIMIZE_SPEED", wxSVG_SHAPE_RENDERING_OPTIMIZE_SPEED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxSYS_CARET_OFF_MSEC", wxSYS_CARET_OFF_MSEC, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSYS_CARET_ON_MSEC", wxSYS_CARET_ON_MSEC, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxSYS_CARET_TIMEOUT_MSEC", wxSYS_CARET_TIMEOUT_MSEC, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxStrip_CJKMnemonics", wxStrip_CJKMnemonics, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxStrip_Menu", wxStrip_Menu, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxTEXT_ATTR_UNDERLINE_DOUBLE", wxTEXT_ATTR_UNDERLINE_DOUBLE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTEXT_ATTR_UNDERLINE_NONE", wxTEXT_ATTR_UNDERLINE_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTEXT_ATTR_UNDERLINE_SOLID", wxTEXT_ATTR_UNDERLINE_SOLID, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTEXT_ATTR_UNDERLINE_SPECIAL", wxTEXT_ATTR_UNDERLINE_SPECIAL, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxTOUCH_ALL_GESTURES", wxTOUCH_ALL_GESTURES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_HORIZONTAL_PAN_GESTURE", wxTOUCH_HORIZONTAL_PAN_GESTURE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_NONE", wxTOUCH_NONE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_PAN_GESTURES", wxTOUCH_PAN_GESTURES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_PRESS_GESTURES", wxTOUCH_PRESS_GESTURES, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_ROTATE_GESTURE", wxTOUCH_ROTATE_GESTURE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_VERTICAL_PAN_GESTURE", wxTOUCH_VERTICAL_PAN_GESTURE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxTOUCH_ZOOM_GESTURE", wxTOUCH_ZOOM_GESTURE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxXRC_USE_ENVVARS", wxXRC_USE_ENVVARS, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxZIP_FORMAT_DEFAULT", wxZIP_FORMAT_DEFAULT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxZIP_FORMAT_ZIP64", wxZIP_FORMAT_ZIP64, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wx_GL_COMPAT_PROFILE", wx_GL_COMPAT_PROFILE, CONST_CS | CONST_PERSISTENT);

    //Variables found on global_variables.json

    REGISTER_LONG_CONSTANT("wxDefaultDateTime", time(NULL), CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GRID_ROW_AUTO_SIZE", wxEVT_GRID_ROW_AUTO_SIZE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GRID_COL_AUTO_SIZE", wxEVT_GRID_COL_AUTO_SIZE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GRID_RANGE_SELECTING", wxEVT_GRID_RANGE_SELECTING, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GRID_RANGE_SELECTED", wxEVT_GRID_RANGE_SELECTED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_GRID_ROW_MOVE", wxEVT_GRID_ROW_MOVE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_LIST_ITEM_CHECKED", wxEVT_LIST_ITEM_CHECKED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_LIST_ITEM_UNCHECKED", wxEVT_LIST_ITEM_UNCHECKED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_SELECTED", wxEVT_PG_SELECTED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_CHANGING", wxEVT_PG_CHANGING, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_CHANGED", wxEVT_PG_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_HIGHLIGHTED", wxEVT_PG_HIGHLIGHTED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_RIGHT_CLICK", wxEVT_PG_RIGHT_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_PAGE_CHANGED", wxEVT_PG_PAGE_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_ITEM_COLLAPSED", wxEVT_PG_ITEM_COLLAPSED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_ITEM_EXPANDED", wxEVT_PG_ITEM_EXPANDED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_DOUBLE_CLICK", wxEVT_PG_DOUBLE_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_LABEL_EDIT_BEGIN", wxEVT_PG_LABEL_EDIT_BEGIN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_LABEL_EDIT_ENDING", wxEVT_PG_LABEL_EDIT_ENDING, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_COL_BEGIN_DRAG", wxEVT_PG_COL_BEGIN_DRAG, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_COL_DRAGGING", wxEVT_PG_COL_DRAGGING, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PG_COL_END_DRAG", wxEVT_PG_COL_END_DRAG, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONTOOLBAR_CLICKED", wxEVT_RIBBONTOOLBAR_CLICKED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONTOOLBAR_DROPDOWN_CLICKED", wxEVT_RIBBONTOOLBAR_DROPDOWN_CLICKED, CONST_CS | CONST_PERSISTENT);
    ...
    char _wxchar_wxART_FULL_SCREEN[] = wxART_FULL_SCREEN;
    ...
    REGISTER_LONG_CONSTANT("wxEVT_AUITOOLBAR_MIDDLE_CLICK", wxEVT_AUITOOLBAR_MIDDLE_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_AUITOOLBAR_BEGIN_DRAG", wxEVT_AUITOOLBAR_BEGIN_DRAG, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_AUI_PANE_ACTIVATED", wxEVT_AUI_PANE_ACTIVATED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_COLOURPICKER_CURRENT_CHANGED", wxEVT_COLOURPICKER_CURRENT_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_COLOURPICKER_DIALOG_CANCELLED", wxEVT_COLOURPICKER_DIALOG_CANCELLED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_COLLAPSIBLEPANE_CHANGED", wxEVT_COLLAPSIBLEPANE_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_COLOUR_CHANGED", wxEVT_COLOUR_CHANGED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_MAGNIFY", wxEVT_MAGNIFY, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_GESTURE_PAN", wxEVT_GESTURE_PAN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GESTURE_ZOOM", wxEVT_GESTURE_ZOOM, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_GESTURE_ROTATE", wxEVT_GESTURE_ROTATE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_TWO_FINGER_TAP", wxEVT_TWO_FINGER_TAP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_LONG_PRESS", wxEVT_LONG_PRESS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_PRESS_AND_TAP", wxEVT_PRESS_AND_TAP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_FULLSCREEN", wxEVT_FULLSCREEN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_ERASE_BACKGROUND", wxEVT_ERASE_BACKGROUND, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_DPI_CHANGED", wxEVT_DPI_CHANGED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_PAGE_CHANGED", wxEVT_RIBBONBAR_PAGE_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_PAGE_CHANGING", wxEVT_RIBBONBAR_PAGE_CHANGING, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TAB_MIDDLE_DOWN", wxEVT_RIBBONBAR_TAB_MIDDLE_DOWN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TAB_MIDDLE_UP", wxEVT_RIBBONBAR_TAB_MIDDLE_UP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TAB_RIGHT_DOWN", wxEVT_RIBBONBAR_TAB_RIGHT_DOWN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TAB_RIGHT_UP", wxEVT_RIBBONBAR_TAB_RIGHT_UP, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TAB_LEFT_DCLICK", wxEVT_RIBBONBAR_TAB_LEFT_DCLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_TOGGLED", wxEVT_RIBBONBAR_TOGGLED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBAR_HELP_CLICK", wxEVT_RIBBONBAR_HELP_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBUTTONBAR_CLICKED", wxEVT_RIBBONBUTTONBAR_CLICKED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONBUTTONBAR_DROPDOWN_CLICKED", wxEVT_RIBBONBUTTONBAR_DROPDOWN_CLICKED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONGALLERY_HOVER_CHANGED", wxEVT_RIBBONGALLERY_HOVER_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONGALLERY_SELECTED", wxEVT_RIBBONGALLERY_SELECTED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_RIBBONGALLERY_CLICKED", wxEVT_RIBBONGALLERY_CLICKED, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_SEARCH", wxEVT_SEARCH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_HOTSPOT_RELEASE_CLICK", wxEVT_STC_HOTSPOT_RELEASE_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_CLIPBOARD_COPY", wxEVT_STC_CLIPBOARD_COPY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_CLIPBOARD_PASTE", wxEVT_STC_CLIPBOARD_PASTE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_AUTOCOMP_COMPLETED", wxEVT_STC_AUTOCOMP_COMPLETED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_MARGIN_RIGHT_CLICK", wxEVT_STC_MARGIN_RIGHT_CLICK, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_STC_AUTOCOMP_SELECTION_CHANGE", wxEVT_STC_AUTOCOMP_SELECTION_CHANGE, CONST_CS | CONST_PERSISTENT);
    ...
    REGISTER_LONG_CONSTANT("wxEVT_WEBREQUEST_STATE", wxEVT_WEBREQUEST_STATE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_WEBREQUEST_DATA", wxEVT_WEBREQUEST_DATA, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_WEBVIEW_FULLSCREEN_CHANGED", wxEVT_WEBVIEW_FULLSCREEN_CHANGED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_WEBVIEW_SCRIPT_MESSAGE_RECEIVED", wxEVT_WEBVIEW_SCRIPT_MESSAGE_RECEIVED, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("wxEVT_WEBVIEW_SCRIPT_RESULT", wxEVT_WEBVIEW_SCRIPT_RESULT, CONST_CS | CONST_PERSISTENT);
    ...
    zend_declare_class_constant_long(php_wxGrid_entry, "wxGridSelectNone", 16,  wxGrid::wxGridSelectNone);
    ...
    zend_declare_class_constant_long(php_wxGridCellAttr_entry, "Default", 7,  wxGridCellAttr::Default);
    zend_declare_class_constant_long(php_wxGridCellAttr_entry, "Merged", 6,  wxGridCellAttr::Merged);
    ...
    zend_declare_class_constant_long(php_wxHtmlEasyPrinting_entry, "Prompt_Never", 12,  wxHtmlEasyPrinting::Prompt_Never);
    zend_declare_class_constant_long(php_wxHtmlEasyPrinting_entry, "Prompt_Once", 11,  wxHtmlEasyPrinting::Prompt_Once);
    zend_declare_class_constant_long(php_wxHtmlEasyPrinting_entry, "Prompt_Always", 13,  wxHtmlEasyPrinting::Prompt_Always);
    ...
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Cache", 9,  wxStandardPaths::Dir_Cache);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Documents", 13,  wxStandardPaths::Dir_Documents);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Desktop", 11,  wxStandardPaths::Dir_Desktop);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Downloads", 13,  wxStandardPaths::Dir_Downloads);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Music", 9,  wxStandardPaths::Dir_Music);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Pictures", 12,  wxStandardPaths::Dir_Pictures);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "Dir_Videos", 10,  wxStandardPaths::Dir_Videos);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "FileLayout_Classic", 18,  wxStandardPaths::FileLayout_Classic);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "FileLayout_XDG", 14,  wxStandardPaths::FileLayout_XDG);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "ConfigFileConv_Dot", 18,  wxStandardPaths::ConfigFileConv_Dot);
    zend_declare_class_constant_long(php_wxStandardPaths_entry, "ConfigFileConv_Ext", 18,  wxStandardPaths::ConfigFileConv_Ext);
    zend_declare_class_constant_long(php_wxStaticBitmap_entry, "Scale_None", 10,  wxStaticBitmap::Scale_None);
    zend_declare_class_constant_long(php_wxStaticBitmap_entry, "Scale_Fill", 10,  wxStaticBitmap::Scale_Fill);
    zend_declare_class_constant_long(php_wxStaticBitmap_entry, "Scale_AspectFit", 15,  wxStaticBitmap::Scale_AspectFit);
    zend_declare_class_constant_long(php_wxStaticBitmap_entry, "Scale_AspectFill", 16,  wxStaticBitmap::Scale_AspectFill);
