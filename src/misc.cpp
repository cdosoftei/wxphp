...
wxArtProvider_php::~wxArtProvider_php()
{
    if (zo) {
...
/* {{{ proto wxSize wxArtProvider::GetSizeHint(string client, wxWindow &win)
...
PHP_METHOD(php_wxArtProvider, GetSizeHint)
{
    ...
    if(!already_called && arguments_received >= 1  && arguments_received <= 2)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 's|z' (&client0, &client_len0, &win0)\n");
        #endif

        char parse_parameters_string[] = "s|z";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &client0, &client_len0, &win0 ) == SUCCESS)
        {
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            case 2:
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Static ");
                php_printf("Executing wxArtProvider::GetSizeHint(wxString(client0, wxConvUTF8), (wxWindow*) object_pointer0_1) to return new object\n\n");
                #endif

                wxSize value_to_return2;
                value_to_return2 = wxArtProvider::GetSizeHint(wxString(client0, wxConvUTF8), (wxWindow*) object_pointer0_1);
                void* ptr = safe_emalloc(1, sizeof(wxSize_php), 0);
...
/* {{{ proto wxSize wxArtProvider::GetNativeSizeHint(string client, wxWindow &win)
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            case 2:
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Static ");
                php_printf("Executing wxArtProvider::GetNativeSizeHint(wxString(client0, wxConvUTF8), (wxWindow*) object_pointer0_1) to return new object\n\n");
                #endif

                wxSize value_to_return2;
                value_to_return2 = wxArtProvider::GetNativeSizeHint(wxString(client0, wxConvUTF8), (wxWindow*) object_pointer0_1);
                void* ptr = safe_emalloc(1, sizeof(wxSize_php), 0);
                memcpy(ptr, (void*) &value_to_return2, sizeof(wxSize));
                object_init_ex(return_value, php_wxSize_entry);
                ((wxSize_php*)ptr)->phpObj = *return_value;
...
/* {{{ proto  wxCaret::wxCaret(wxWindow &window, int width, int height)
...
PHP_METHOD(php_wxCaret, __construct)
{
    ...
    if(!already_called && arguments_received == 3)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'zll' (&window0, &width0, &height0)\n");
        #endif

        char parse_parameters_string[] = "zll";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &window0, &width0, &height0 ) == SUCCESS)
        {
            if(arguments_received >= 1){
    ...
    if(!already_called && arguments_received == 2)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'zO' (&window1, &size1, php_wxSize_entry)\n");
        #endif

        char parse_parameters_string[] = "zO";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &window1, &size1, php_wxSize_entry ) == SUCCESS)
        {
            if(arguments_received >= 1){
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing __construct((wxWindow*) object_pointer0_0, (int) width0, (int) height0)\n");
                #endif

                native_object = new wxCaret_php((wxWindow*) object_pointer0_0, (int) width0, (int) height0);

                native_object->references.Initialize();
                ((wxCaret_php*) native_object)->references.AddReference(window0, "wxCaret::wxCaret at call 2 with 3 argument(s)");
                break;
            }
        }
    }
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing __construct((wxWindow*) object_pointer1_0, *(wxSize*) object_pointer1_1)\n");
                #endif

                native_object = new wxCaret_php((wxWindow*) object_pointer1_0, *(wxSize*) object_pointer1_1);

                native_object->references.Initialize();
                ((wxCaret_php*) native_object)->references.AddReference(window1, "wxCaret::wxCaret at call 2 with 2 argument(s)");
                ((wxCaret_php*) native_object)->references.AddReference(size1, "wxCaret::wxCaret at call 4 with 2 argument(s)");
                break;
            }
        }
    }
...
/* {{{ proto  wxCaret::SetSize(int width, int height)
...
PHP_METHOD(php_wxCaret, SetSize)
{
    ...
    if(!already_called && arguments_received == 1)
    {
        ...
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &size1, php_wxSize_entry ) == SUCCESS)
        {
            if(arguments_received >= 1){
                if(Z_TYPE_P(size1) == IS_OBJECT)
                {
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::SetSize((int) width0, (int) height0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->SetSize((int) width0, (int) height0);
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::SetSize(*(wxSize*) object_pointer1_0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->SetSize(*(wxSize*) object_pointer1_0);

                references->AddReference(size1, "wxCaret::SetSize at call 3 with 1 argument(s)");
...
/* {{{ proto  wxCaret::Move(int x, int y)
...
PHP_METHOD(php_wxCaret, Move)
{
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::Move((int) x0, (int) y0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->Move((int) x0, (int) y0);
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::Move(*(wxPoint*) object_pointer1_0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->Move(*(wxPoint*) object_pointer1_0);

                references->AddReference(pt1, "wxCaret::Move at call 3 with 1 argument(s)");
...
/* {{{ proto  wxCaret::GetSize(int &width, int &height)
   Get the caret size. */
PHP_METHOD(php_wxCaret, GetSize)
{
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::GetSize((int*) width0, (int*) height0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->GetSize((int*) width0, (int*) height0);
...
/* {{{ proto  wxCaret::GetPosition(int &x, int &y)
...
PHP_METHOD(php_wxCaret, GetPosition)
{
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxCaret::GetPosition((int*) x0, (int*) y0)\n\n");
                #endif

                ((wxCaret_php*)native_object)->GetPosition((int*) x0, (int*) y0);
...
wxNotificationMessage_php::~wxNotificationMessage_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxStopWatch_php::~wxStopWatch_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxTaskBarIcon_php::~wxTaskBarIcon_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
/* {{{ proto bool wxTaskBarIcon::SetIcon(wxBitmapBundle icon, string tooltip)
...
PHP_METHOD(php_wxTaskBarIcon, SetIcon)
{
    ...
    if(!already_called && arguments_received >= 1  && arguments_received <= 2)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'O|s' (&icon0, php_wxBitmapBundle_entry, &tooltip0, &tooltip_len0)\n");
        #endif

        char parse_parameters_string[] = "O|s";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &icon0, php_wxBitmapBundle_entry, &tooltip0, &tooltip_len0 ) == SUCCESS)
        {
            if(arguments_received >= 1){
...
wxWindowDisabler_php::~wxWindowDisabler_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
PHP_METHOD(php_wxWindowDisabler, __construct)
{
    ...
    if(!already_called && arguments_received >= 1  && arguments_received <= 2)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'z|z' (&winToSkip1, &winToSkip21)\n");
        #endif

        char parse_parameters_string[] = "z|z";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &winToSkip1, &winToSkip21 ) == SUCCESS)
        {
            if(arguments_received >= 1){
            ...
            if(arguments_received >= 2){
                if(Z_TYPE_P(winToSkip21) == IS_OBJECT)
                {
                    wxphp_object_type argument_type = Z_wxWindow_P(winToSkip21)->object_type;
                    argument_native_object = (void*) Z_wxWindow_P(winToSkip21)->native_object;
                    object_pointer1_1 = (wxWindow*) argument_native_object;
                    if (!object_pointer1_1 || (argument_type != PHP_WXWINDOW_TYPE && argument_type != PHP_WXNONOWNEDWINDOW_TYPE && argument_type != PHP_WXTOPLEVELWINDOW_TYPE && argument_type != PHP_WXFRAME_TYPE && argument_type != PHP_WXSPLASHSCREEN_TYPE && argument_type != PHP_WXMDICHILDFRAME_TYPE && argument_type != PHP_WXMDIPARENTFRAME_TYPE && argument_type != PHP_WXMINIFRAME_TYPE && argument_type != PHP_WXPREVIEWFRAME_TYPE && argument_type != PHP_WXHTMLHELPFRAME_TYPE && argument_type != PHP_WXDIALOG_TYPE && argument_type != PHP_WXTEXTENTRYDIALOG_TYPE && argument_type != PHP_WXPASSWORDENTRYDIALOG_TYPE && argument_type != PHP_WXMESSAGEDIALOG_TYPE && argument_type != PHP_WXFINDREPLACEDIALOG_TYPE && argument_type != PHP_WXDIRDIALOG_TYPE && argument_type != PHP_WXSYMBOLPICKERDIALOG_TYPE && argument_type != PHP_WXPROPERTYSHEETDIALOG_TYPE && argument_type != PHP_WXWIZARD_TYPE && argument_type != PHP_WXCOLOURDIALOG_TYPE && argument_type != PHP_WXFILEDIALOG_TYPE && argument_type != PHP_WXFONTDIALOG_TYPE && argument_type != PHP_WXSINGLECHOICEDIALOG_TYPE && argument_type != PHP_WXHTMLHELPDIALOG_TYPE && argument_type != PHP_WXGENERICPROGRESSDIALOG_TYPE && argument_type != PHP_WXPROGRESSDIALOG_TYPE && argument_type != PHP_WXPOPUPWINDOW_TYPE && argument_type != PHP_WXPOPUPTRANSIENTWINDOW_TYPE && argument_type != PHP_WXCONTROL_TYPE && argument_type != PHP_WXSTATUSBAR_TYPE && argument_type != PHP_WXANYBUTTON_TYPE && argument_type != PHP_WXBUTTON_TYPE && argument_type != PHP_WXBITMAPBUTTON_TYPE && argument_type != PHP_WXTOGGLEBUTTON_TYPE && argument_type != PHP_WXBITMAPTOGGLEBUTTON_TYPE && argument_type != PHP_WXTREECTRL_TYPE && argument_type != PHP_WXLISTBOX_TYPE && argument_type != PHP_WXCHECKLISTBOX_TYPE && argument_type != PHP_WXREARRANGELIST_TYPE && argument_type != PHP_WXCONTROLWITHITEMS_TYPE && argument_type != PHP_WXBOOKCTRLBASE_TYPE && argument_type != PHP_WXAUINOTEBOOK_TYPE && argument_type != PHP_WXLISTBOOK_TYPE && argument_type != PHP_WXCHOICEBOOK_TYPE && argument_type != PHP_WXNOTEBOOK_TYPE && argument_type != PHP_WXTREEBOOK_TYPE && argument_type != PHP_WXTOOLBOOK_TYPE && argument_type != PHP_WXANIMATIONCTRL_TYPE && argument_type != PHP_WXSTYLEDTEXTCTRL_TYPE && argument_type != PHP_WXSCROLLBAR_TYPE && argument_type != PHP_WXSTATICTEXT_TYPE && argument_type != PHP_WXSTATICLINE_TYPE && argument_type != PHP_WXSTATICBOX_TYPE && argument_type != PHP_WXSTATICBITMAP_TYPE && argument_type != PHP_WXCHECKBOX_TYPE && argument_type != PHP_WXTEXTCTRL_TYPE && argument_type != PHP_WXCOMBOBOX_TYPE && argument_type != PHP_WXBITMAPCOMBOBOX_TYPE && argument_type != PHP_WXAUITOOLBAR_TYPE && argument_type != PHP_WXCHOICE_TYPE && argument_type != PHP_WXLISTCTRL_TYPE && argument_type != PHP_WXLISTVIEW_TYPE && argument_type != PHP_WXRADIOBOX_TYPE && argument_type != PHP_WXRADIOBUTTON_TYPE && argument_type != PHP_WXSLIDER_TYPE && argument_type != PHP_WXSPINCTRL_TYPE && argument_type != PHP_WXSPINBUTTON_TYPE && argument_type != PHP_WXGAUGE_TYPE && argument_type != PHP_WXHYPERLINKCTRL_TYPE && argument_type != PHP_WXSEARCHCTRL_TYPE && argument_type != PHP_WXSPINCTRLDOUBLE_TYPE && argument_type != PHP_WXGENERICDIRCTRL_TYPE && argument_type != PHP_WXCALENDARCTRL_TYPE && argument_type != PHP_WXPICKERBASE_TYPE && argument_type != PHP_WXCOLOURPICKERCTRL_TYPE && argument_type != PHP_WXFONTPICKERCTRL_TYPE && argument_type != PHP_WXFILEPICKERCTRL_TYPE && argument_type != PHP_WXDIRPICKERCTRL_TYPE && argument_type != PHP_WXTIMEPICKERCTRL_TYPE && argument_type != PHP_WXTOOLBAR_TYPE && argument_type != PHP_WXDATEPICKERCTRL_TYPE && argument_type != PHP_WXCOLLAPSIBLEPANE_TYPE && argument_type != PHP_WXCOMBOCTRL_TYPE && argument_type != PHP_WXDATAVIEWCTRL_TYPE && argument_type != PHP_WXDATAVIEWLISTCTRL_TYPE && argument_type != PHP_WXDATAVIEWTREECTRL_TYPE && argument_type != PHP_WXHEADERCTRL_TYPE && argument_type != PHP_WXHEADERCTRLSIMPLE_TYPE && argument_type != PHP_WXFILECTRL_TYPE && argument_type != PHP_WXINFOBAR_TYPE && argument_type != PHP_WXRIBBONCONTROL_TYPE && argument_type != PHP_WXRIBBONBAR_TYPE && argument_type != PHP_WXRIBBONBUTTONBAR_TYPE && argument_type != PHP_WXRIBBONGALLERY_TYPE && argument_type != PHP_WXRIBBONPAGE_TYPE && argument_type != PHP_WXRIBBONPANEL_TYPE && argument_type != PHP_WXRIBBONTOOLBAR_TYPE && argument_type != PHP_WXMEDIACTRL_TYPE && argument_type != PHP_WXSPLITTERWINDOW_TYPE && argument_type != PHP_WXPANEL_TYPE && argument_type != PHP_WXSCROLLEDWINDOW_TYPE && argument_type != PHP_WXHTMLWINDOW_TYPE && argument_type != PHP_WXPREVIEWCANVAS_TYPE && argument_type != PHP_WXWIZARDPAGE_TYPE && argument_type != PHP_WXWIZARDPAGESIMPLE_TYPE && argument_type != PHP_WXEDITABLELISTBOX_TYPE && argument_type != PHP_WXHSCROLLEDWINDOW_TYPE && argument_type != PHP_WXPREVIEWCONTROLBAR_TYPE && argument_type != PHP_WXMENUBAR_TYPE && argument_type != PHP_WXBANNERWINDOW_TYPE && argument_type != PHP_WXMDICLIENTWINDOW_TYPE && argument_type != PHP_WXTREELISTCTRL_TYPE && argument_type != PHP_WXSASHWINDOW_TYPE && argument_type != PHP_WXSASHLAYOUTWINDOW_TYPE && argument_type != PHP_WXHTMLHELPWINDOW_TYPE))
                    {
                        zend_error(E_ERROR, "Parameter 'winToSkip2' could not be retreived correctly.");
                    }
                }
                else if(Z_TYPE_P(winToSkip21) != IS_NULL)
                {
                    zend_error(E_ERROR, "Parameter 'winToSkip2' not null, could not be retreived correctly.");
                }
            }
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing __construct((wxWindow*) object_pointer1_0, (wxWindow*) object_pointer1_1)\n");
                #endif

                native_object = new wxWindowDisabler_php((wxWindow*) object_pointer1_0, (wxWindow*) object_pointer1_1);

                native_object->references.Initialize();
                ((wxWindowDisabler_php*) native_object)->references.AddReference(winToSkip1, "wxWindowDisabler::wxWindowDisabler at call 2 with 2 argument(s)");
                ((wxWindowDisabler_php*) native_object)->references.AddReference(winToSkip21, "wxWindowDisabler::wxWindowDisabler at call 2 with 2 argument(s)");
                break;
            }
        }
    }
...
wxBusyCursor_php::~wxBusyCursor_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
