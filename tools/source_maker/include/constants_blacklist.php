...
// 3.1.x
unset($defConsts['wxPG_DEFAULT_IMAGE_SIZE']);
unset($defConsts['wxPG_NULL_BITMAP']);
unset($defConsts['wxSTC_4GL_BLOCK']);
unset($defConsts['wxSTC_4GL_BLOCK_']);
unset($defConsts['wxSTC_4GL_CHARACTER']);
unset($defConsts['wxSTC_4GL_CHARACTER_']);
unset($defConsts['wxSTC_4GL_COMMENT1']);
unset($defConsts['wxSTC_4GL_COMMENT1_']);
unset($defConsts['wxSTC_4GL_COMMENT2']);
unset($defConsts['wxSTC_4GL_COMMENT2_']);
unset($defConsts['wxSTC_4GL_COMMENT3']);
unset($defConsts['wxSTC_4GL_COMMENT3_']);
unset($defConsts['wxSTC_4GL_COMMENT4']);
unset($defConsts['wxSTC_4GL_COMMENT4_']);
unset($defConsts['wxSTC_4GL_COMMENT5']);
unset($defConsts['wxSTC_4GL_COMMENT5_']);
unset($defConsts['wxSTC_4GL_COMMENT6']);
unset($defConsts['wxSTC_4GL_COMMENT6_']);
unset($defConsts['wxSTC_4GL_DEFAULT']);
unset($defConsts['wxSTC_4GL_DEFAULT_']);
unset($defConsts['wxSTC_4GL_END']);
unset($defConsts['wxSTC_4GL_END_']);
unset($defConsts['wxSTC_4GL_IDENTIFIER']);
unset($defConsts['wxSTC_4GL_IDENTIFIER_']);
unset($defConsts['wxSTC_4GL_NUMBER']);
unset($defConsts['wxSTC_4GL_NUMBER_']);
unset($defConsts['wxSTC_4GL_OPERATOR']);
unset($defConsts['wxSTC_4GL_OPERATOR_']);
unset($defConsts['wxSTC_4GL_PREPROCESSOR']);
unset($defConsts['wxSTC_4GL_PREPROCESSOR_']);
unset($defConsts['wxSTC_4GL_STRING']);
unset($defConsts['wxSTC_4GL_STRING_']);
unset($defConsts['wxSTC_4GL_WORD']);
unset($defConsts['wxSTC_4GL_WORD_']);
unset($defConsts['wxTASKBAR_BUTTON_ERROR']);
unset($defConsts['wxTASKBAR_BUTTON_INDETERMINATE']);
unset($defConsts['wxTASKBAR_BUTTON_NO_PROGRESS']);
unset($defConsts['wxTASKBAR_BUTTON_NORMAL']);
unset($defConsts['wxTASKBAR_BUTTON_PAUSED']);
unset($defConsts['wxTASKBAR_JUMP_LIST_DESTINATION']);
unset($defConsts['wxTASKBAR_JUMP_LIST_SEPARATOR']);
