...
static zend_function_entry php_wxGraphicsGradientStop_functions[] = {
    PHP_ME(php_wxGraphicsGradientStop, GetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStop, GetPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStop, SetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStop, SetPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStop, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxGraphicsGradientStops_functions[] = {
    PHP_ME(php_wxGraphicsGradientStops, Add, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, GetCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, GetEndColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, GetStartColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, Item, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, SetEndColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, SetStartColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxGraphicsGradientStops, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxBitmapHandler_functions[] = {
    PHP_ME(php_wxBitmapHandler, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxBitmapHandler, SetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, SetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, SetExtension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, LoadFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, GetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, GetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, GetExtension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, SaveFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmapHandler, Create, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxBitmap_functions[] = {
    PHP_ME(php_wxBitmap, AddHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, CleanUpHandlers, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, ConvertToDisabled, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    ...
    PHP_ME(php_wxBitmap, FindHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetDepth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetPalette, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetSubBitmap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, InitStandardHandlers, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, InsertHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, SetMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBitmap, SetPalette, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxMask_functions[] = {
    PHP_ME(php_wxMask, Create, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxMask, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxBrush_functions[] = {
    PHP_ME(php_wxBrush, GetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, GetStipple, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, GetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, IsHatch, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, IsNonTransparent, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, IsTransparent, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, SetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, SetStipple, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, SetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxBrush, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxColour_functions[] = {
    PHP_ME(php_wxColour, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxColour, Set, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, Red, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, SetRGB, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, SetRGBA, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, Blue, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, Green, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, GetRGBA, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, GetRGB, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColour, Alpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxCursor_functions[] = {
    PHP_ME(php_wxCursor, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCursor, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxDCClipper_functions[] = {
    PHP_ME(php_wxDCClipper, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxFont_functions[] = {
    PHP_ME(php_wxFont, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxFont, Bold, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetDefaultEncoding, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetEncoding, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetFaceName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetFamily, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetNativeFontInfoDesc, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetNativeFontInfoUserDesc, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetPixelSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetPointSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetUnderlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetWeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, IsFixedWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Italic, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Larger, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, MakeBold, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, MakeItalic, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, MakeLarger, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, MakeSmaller, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, MakeUnderlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, NewMethod, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Scale, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Scaled, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetDefaultEncoding, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetEncoding, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetFaceName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetFamily, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetNativeFontInfo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetNativeFontInfoUserDesc, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetPixelSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetPointSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetSymbolicSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetSymbolicSizeRelativeTo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetUnderlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, SetWeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Smaller, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, Underlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFont, GetNativeFontInfo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxFontList_functions[] = {
    PHP_ME(php_wxFontList, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxFontList, FindOrCreateFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxFontEnumerator_functions[] = {
    PHP_ME(php_wxFontEnumerator, IsValidFacename, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFontEnumerator, GetFacenames, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFontEnumerator, GetEncodings, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFontEnumerator, EnumerateFacenames, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFontEnumerator, EnumerateEncodings, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxNativeFontInfo_functions[] = {
    PHP_ME(php_wxNativeFontInfo, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxNativeFontInfo, FromString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, FromUserString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetEncoding, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetFaceName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetFamily, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetPointSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetUnderlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, GetWeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, Init, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, InitFromFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetEncoding, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetFaceName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetFamily, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetPointSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetUnderlined, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, SetWeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, ToString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxNativeFontInfo, ToUserString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxColourDatabase_functions[] = {
    PHP_ME(php_wxColourDatabase, AddColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColourDatabase, Find, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColourDatabase, FindName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxColourDatabase, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxIcon_functions[] = {
    ...
    PHP_ME(php_wxIcon, GetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIcon, GetDepth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIcon, CopyFromBitmap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxIconBundle_functions[] = {
    PHP_ME(php_wxIconBundle, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxIconBundle, IsEmpty, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIconBundle, GetIconOfExactSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIconBundle, GetIconCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIconBundle, GetIconByIndex, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIconBundle, AddIcon, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxIconBundle, GetIcon, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxImageHandler_functions[] = {
    PHP_ME(php_wxImageHandler, CanRead, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetAltExtensions, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetExtension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetImageCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetMimeType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, GetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, LoadFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, SaveFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, SetAltExtensions, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, SetExtension, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, SetMimeType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageHandler, SetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxImage_functions[] = {
    PHP_ME(php_wxImage, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxImage, SetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetRGB, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetPalette, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetOption, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetMaskFromImage, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetMaskColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SetAlpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Scale, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, SaveFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, RotateHue, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Rotate90, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Rotate180, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Rotate, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Resize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Rescale, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Replace, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, RemoveHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Paste, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Mirror, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, LoadFile, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, IsTransparent, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, InsertHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, InitStandardHandlers, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, InitAlpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, HasOption, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, HasMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, HasAlpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetSubImage, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetRed, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetPalette, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetOrFindMaskColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetOptionInt, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetOption, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetMaskRed, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetMaskGreen, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetMaskBlue, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetImageExtWildcard, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetImageCount, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetGreen, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetBlue, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, GetAlpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, FindHandlerMime, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, FindHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, FindFirstUnusedColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Destroy, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Create, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Copy, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, ConvertToMono, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, ConvertToGreyscale, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, ConvertToDisabled, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, ConvertAlphaToMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, ClearAlpha, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Clear, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, CleanUpHandlers, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, CanRead, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, BlurVertical, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, BlurHorizontal, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Blur, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, AddHandler, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImage, Size, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxImageList_functions[] = {
    PHP_ME(php_wxImageList, Add, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, Create, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, GetBitmap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, GetIcon, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, GetImageCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, Remove, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, RemoveAll, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, Replace, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxImageList, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxImageList, Draw, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxPalette_functions[] = {
    PHP_ME(php_wxPalette, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxPalette, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPalette, GetPixel, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPalette, GetColoursCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPalette, Create, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPalette, GetRGB, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxPen_functions[] = {
    PHP_ME(php_wxPen, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxPen, IsTransparent, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, IsNonTransparent, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetStipple, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetJoin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, GetCap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetJoin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetStipple, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPen, SetCap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxPenList_functions[] = {
    PHP_ME(php_wxPenList, FindOrCreatePen, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPenList, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxRendererNative_functions[] = {
    PHP_ME(php_wxRendererNative, Get, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRendererNative, GetDefault, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRendererNative, GetGeneric, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRendererNative, Load, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRendererNative, Set, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
