...
static zend_function_entry php_wxClientData_functions[] = {
    PHP_ME(php_wxClientData, __construct, arginfo_tmp_placeholder, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxTreeItemData_functions[] = {
    PHP_ME(php_wxTreeItemData, GetId, arginfo_tmp_placeholder, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxTreeItemData, SetId, arginfo_tmp_placeholder, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxTreeItemData, __construct, arginfo_tmp_placeholder, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
