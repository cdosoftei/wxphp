...
static zend_function_entry php_wxAcceleratorEntry_functions[] = {
    PHP_ME(php_wxAcceleratorEntry, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxAcceleratorEntry, ToString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, Set, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, GetMenuItem, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, GetKeyCode, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, GetFlags, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, GetCommand, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorEntry, FromString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxAcceleratorTable_functions[] = {
    PHP_ME(php_wxAcceleratorTable, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxAcceleratorTable, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxCalendarDateAttr_functions[] = {
    PHP_ME(php_wxCalendarDateAttr, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxCalendarDateAttr, SetTextColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetHoliday, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetBorderColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetBackgroundColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, IsHoliday, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, HasTextColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, HasFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, HasBorderColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, HasBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, HasBackgroundColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetTextColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetMark, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetBorderColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetBorder, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, GetBackgroundColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxCalendarDateAttr, SetMark, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxPageSetupDialogData_functions[] = {
    PHP_ME(php_wxPageSetupDialogData, EnableHelp, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, EnableMargins, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, EnableOrientation, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, EnablePaper, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, EnablePrinter, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetDefaultInfo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetDefaultMinMargins, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetEnableHelp, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetEnableMargins, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetEnableOrientation, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetEnablePaper, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetEnablePrinter, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetMarginBottomRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetMarginTopLeft, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetMinMarginBottomRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetMinMarginTopLeft, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetPaperId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetPaperSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, GetPrintData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetDefaultInfo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetDefaultMinMargins, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetMarginBottomRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetMarginTopLeft, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetMinMarginBottomRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetMinMarginTopLeft, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetPaperId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetPaperSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, SetPrintData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPageSetupDialogData, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxPrintData_functions[] = {
    PHP_ME(php_wxPrintData, GetBin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetCollate, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetDuplex, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetFilename, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetNoCopies, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetOrientation, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetPaperId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetPrintMode, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetPrinterName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, GetQuality, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetBin, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetCollate, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetDuplex, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetFilename, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetNoCopies, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetOrientation, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetPaperId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetPrintMode, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetPrinterName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, SetQuality, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPrintData, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxRect_functions[] = {
    PHP_ME(php_wxRect, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxRect, SetX, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, SetY, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Union, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, SetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, SetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, SetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Offset, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, IsEmpty, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Intersects, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Intersect, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Inflate, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetY, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetX, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetTopRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetTopLeft, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetTop, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetSize, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetRight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetPosition, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, CenterIn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, CentreIn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Contains, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, Deflate, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetBottom, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRect, GetBottomLeft, arginfo_null, ZEND_ACC_PUBLIC)
...
static zend_function_entry php_wxSize_functions[] = {
    PHP_ME(php_wxSize, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxSize, SetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, SetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, SetDefaults, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, Set, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, GetHeight, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, IsFullySpecified, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, Scale, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, DecTo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxSize, IncTo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxListItem_functions[] = {
    PHP_ME(php_wxListItem, Clear, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxListItem, SetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetTextColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetText, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetStateMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetState, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetImage, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetColumn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetBackgroundColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, SetAlign, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetTextColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetText, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetState, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetMask, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetImage, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetId, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetAlign, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetBackgroundColour, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetColumn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxListItem, GetFont, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxFileType_functions[] = {
    PHP_ME(php_wxFileType, GetDescription, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxFileType, GetExtensions, arginfo_null, ZEND_ACC_PUBLIC)
...
static zend_function_entry php_wxPosition_functions[] = {
    PHP_ME(php_wxPosition, GetCol, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, GetColumn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, GetRow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, SetCol, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, SetColumn, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, SetRow, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPosition, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxRegion_functions[] = {
    PHP_ME(php_wxRegion, Clear, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, Contains, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, ConvertToBitmap, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, GetBox, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, Intersect, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, IsEmpty, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, IsEqual, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, Offset, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, Subtract, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, Union, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, XorMethod, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxRegion, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxStatusBarPane_functions[] = {
    PHP_ME(php_wxStatusBarPane, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxStatusBarPane, GetText, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxStatusBarPane, GetStyle, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxStatusBarPane, GetWidth, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxTreeItemId_functions[] = {
    PHP_ME(php_wxTreeItemId, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxTreeItemId, IsOk, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxVariant_functions[] = {
    PHP_ME(php_wxVariant, Append, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, Clear, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, ClearList, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, Convert, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, Delete, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetArrayString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetBool, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetDateTime, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetDouble, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetLong, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetVoidPtr, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetWxObjectPtr, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, Insert, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, IsNull, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, IsValueKindOf, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, MakeNull, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, MakeString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, Member, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, IsType, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, GetCount, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, NullList, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, SetData, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariant, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxVariantData_functions[] = {
    PHP_ME(php_wxVariantData, CloneMethod, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, DecRef, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, GetValueClassInfo, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, IncRef, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, Read, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, Write, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVariantData, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_FE_END
};
#endif
...
static zend_function_entry php_wxVersionInfo_functions[] = {
    PHP_ME(php_wxVersionInfo, ToString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, HasCopyright, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetVersionString, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetMinor, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetMicro, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetMajor, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetDescription, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, GetCopyright, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxVersionInfo, __construct, arginfo_null, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
    PHP_ME(php_wxVersionInfo, HasDescription, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
#endif
