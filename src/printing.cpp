...
wxPrinterDC_php::~wxPrinterDC_php()
{
    if (zo) {
...
wxPreviewControlBar_php::~wxPreviewControlBar_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxPreviewCanvas_php::~wxPreviewCanvas_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxPreviewFrame_php::~wxPreviewFrame_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxPrintPreview_php::~wxPrintPreview_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
PHP_METHOD(php_wxPrintPreview, __construct)
{
    ...
    zval* printout1;
    wxPrintout* object_pointer1_0 = 0;
    zval* printoutForPrinting1;
    wxPrintout* object_pointer1_1 = 0;
    zval* data1;
    wxPrintData* object_pointer1_2 = 0;
    ...
    if(!already_called && arguments_received == 3)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'zzz' (&printout1, &printoutForPrinting1, &data1)\n");
        #endif

        char parse_parameters_string[] = "zzz";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &printout1, &printoutForPrinting1, &data1 ) == SUCCESS)
        {
            if(arguments_received >= 1){
                if(Z_TYPE_P(printout1) == IS_OBJECT)
                {
                    wxphp_object_type argument_type = Z_wxPrintout_P(printout1)->object_type;
                    argument_native_object = (void*) Z_wxPrintout_P(printout1)->native_object;
                    object_pointer1_0 = (wxPrintout*) argument_native_object;
                    if (!object_pointer1_0 || (argument_type != PHP_WXPRINTOUT_TYPE && argument_type != PHP_WXHTMLPRINTOUT_TYPE))
                    {
                        zend_error(E_ERROR, "Parameter 'printout' could not be retreived correctly.");
                    }
                }
                else if(Z_TYPE_P(printout1) != IS_NULL)
                {
                    zend_error(E_ERROR, "Parameter 'printout' not null, could not be retreived correctly.");
                }
            }
            ...
            if(arguments_received >= 2){
                if(Z_TYPE_P(printoutForPrinting1) == IS_OBJECT)
                {
                    wxphp_object_type argument_type = Z_wxPrintout_P(printoutForPrinting1)->object_type;
                    argument_native_object = (void*) Z_wxPrintout_P(printoutForPrinting1)->native_object;
                    object_pointer1_1 = (wxPrintout*) argument_native_object;
                    if (!object_pointer1_1 || (argument_type != PHP_WXPRINTOUT_TYPE && argument_type != PHP_WXHTMLPRINTOUT_TYPE))
                    {
                        zend_error(E_ERROR, "Parameter 'printoutForPrinting' could not be retreived correctly.");
                    }
                }
                else if(Z_TYPE_P(printoutForPrinting1) != IS_NULL)
                {
            ...
            if(arguments_received >= 3){
                if(Z_TYPE_P(data1) == IS_OBJECT)
                {
                    ...
                    object_pointer1_2 = (wxPrintData*) argument_native_object;
                    if (!object_pointer1_2 || (argument_type != PHP_WXPRINTDATA_TYPE))
                    {
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing __construct((wxPrintout*) object_pointer1_0, (wxPrintout*) object_pointer1_1, (wxPrintData*) object_pointer1_2)\n");
                #endif

                native_object = new wxPrintPreview_php((wxPrintout*) object_pointer1_0, (wxPrintout*) object_pointer1_1, (wxPrintData*) object_pointer1_2);

                native_object->references.Initialize();
                ((wxPrintPreview_php*) native_object)->references.AddReference(printout1, "wxPrintPreview::wxPrintPreview at call 2 with 3 argument(s)");
                ((wxPrintPreview_php*) native_object)->references.AddReference(printoutForPrinting1, "wxPrintPreview::wxPrintPreview at call 2 with 3 argument(s)");
                ((wxPrintPreview_php*) native_object)->references.AddReference(data1, "wxPrintPreview::wxPrintPreview at call 2 with 3 argument(s)");
                break;
            }
        }
    }
...
wxPrintDialog_php::~wxPrintDialog_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
...
wxPageSetupDialog_php::~wxPageSetupDialog_php()
{
    if (zo) {
        zo->native_object = NULL;
    }
