...
static zend_function_entry php_wxPlatformInfo_functions[] = {
    ...
    PHP_ME(php_wxPlatformInfo, GetArch, arginfo_null, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPlatformInfo, GetArchName, arginfo_null, ZEND_ACC_PUBLIC)
    PHP_ME(php_wxPlatformInfo, GetArchitecture, arginfo_null, ZEND_ACC_PUBLIC)
    ...
    PHP_ME(php_wxPlatformInfo, SetArchitecture, arginfo_null, ZEND_ACC_PUBLIC)
